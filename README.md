...
**Documentation: [furuse.work](https://furuse.work/)** — the operator index (2,082
operators in the machine-readable index, `docs/OP_INDEX.json`: 931 single-input 2-D operators +
17 n-ary + 1,134 in the typed ledgers, each with a per-operator note), the family guides, and the
release notes.
...
| Look up any of the 2,082 operators in the machine-readable index | `docs/ops/INDEX.md` (full TOC) · `docs/OP_CATALOG.md` (one-page catalog) |
