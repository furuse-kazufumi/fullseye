...
**Documentation: [furuse.work](https://furuse.work/)** — the operator index (2,036
operators in the machine-readable index, `docs/OP_INDEX.json`: 934 single-input 2-D operators +
...
| Look up any of the 2,036 operators in the machine-readable index | `docs/ops/INDEX.md` (full TOC) · `docs/OP_CATALOG.md` (one-page catalog) |
