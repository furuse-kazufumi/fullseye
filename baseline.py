...
def main() -> int:
    ...
    result = {
        ...
        "trivial": {"holdout": round(prob.score_stages(problems.trivial_stages(), ho), 4),
                    "locked_holdout": round(prob.score_stages(problems.trivial_stages(), lo), 4),
                    "pipeline": "identity"},
        "hand": {"train": round(prob.score_stages(hand, tr), 4),
                 "holdout": round(prob.score_stages(hand, ho), 4),
                 "locked_holdout": round(prob.score_stages(hand, lo), 4),
