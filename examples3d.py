...
EXAMPLES = [
    ...
    {"id": "itokawa_regolith_hero", "task": "rendering", "data": "itokawa",
     "name": "小惑星イトカワを物理ベースで描く(Hapke 反射則・太陽視直径 0.53° のレイキャスト影・地形レリーフ)",
     "summary": "実形状モデル(49,152 面)に mesh_displace_fbm / terrain_region_mask / mesh_scatter_boulders で起伏と岩(べき則 D^-3.1)を足し、render_regolith(Hapke + shadow_raycast + 環境光 0 + 線形トーン)で hero を描く。Lommel-Seeliger の縁の明るさ、対向効果、硬い影、岩の個数を GT で実測。"},
