...
MOSAIC_TILES = [
    ...
    ("evis_muscle_heatmap_still.png", (0.050, 0.140, 0.800, 0.870), "demo"),
    ...
    ("academic_paleo_ammonite_real.png", (0.740, 0.000, 0.920, 1.000), "real"),
    # -- row 5 ------------------------------------------------------------
    ...
    ("industrial_blobs.png",        (0.360, 0.050, 0.660, 0.800), "demo"),
