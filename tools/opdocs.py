...
def cmd_toc():
    ...
    for dim in dims:
        ...
        written += 1
    # top INDEX
    top = ["# Fullseye Operator Docs — AI 使い方コーパス", "",
           "op ごとの使い方を Markdown で1件1ファイル(RAD コーパス形状)に持ち、Studio の HTML ヘルプは"
           "ここから一括変換で生成する(`tools/opdocs.py html`)。この目次はフォルダ階層から自動生成。", ""]
    for dim in dims:
