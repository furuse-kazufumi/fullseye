...
_SPEC: tuple = (
    ...
    ("gaussian", t_gaussian, _F64,
     "cv2.GaussianBlur、scipy の半径 int(4σ+0.5) を明示 + BORDER_REFLECT。full-image bit 一致(6e-16)。2048² 61.0→7.1 ms(8.6x、本 module のベンチ)"),
    ("mean_box", t_mean_box, _F64U8,
     "cv2.blur + BORDER_REFLECT。full-image 一致(2e-15)。2048² 53.1→11.2 ms(4.7x)"),
    ...
    ("gopen", t_gopen, _F64U8, "cv2.morphologyEx OPEN。bit 一致(0.0)。2048² 150.9→19.8 ms(7.6x)"),
