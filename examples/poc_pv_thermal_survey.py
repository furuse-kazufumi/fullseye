...
R_HOT = 0.030              # その半径 [m]
MOD_HOT = 4                # ホットスポットを置くモジュール番号(中央)
...
SHADE_DEG, SHADE_W = 22.0, 0.24   # 支柱の影の向き [deg] と幅 [m]
SHADE_C = 0.55             # 影の帯の位置(左端からの距離 [m])
GRASS = ((0.30, 0.10), (0.55, 0.075))   # 雑草の影(モジュール 2 内の相対位置, 半径)
