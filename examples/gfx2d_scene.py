...
7. layer_stack は over を畳んだものと**厳密に同じ**(差 0.0)。opacity=0 は恒等。
8. sRGB ⇄ 線形は厳密な逆写像(1e-16)。0.5 の線形値は ((0.5+0.055)/1.055)^2.4。
   normal_map_decode した半球を正面から照らすと明るさは法線の z 成分そのもの。
"""
