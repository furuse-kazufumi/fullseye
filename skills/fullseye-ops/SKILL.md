...
Fullseye ships **2183 operator notes** in **41 families** — one generated Markdown note per registered operator — plus **57 family guides**. **The notes are the knowledge base**: retrieve first, then write code.
