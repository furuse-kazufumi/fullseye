...
Fullseye ships **2078 operator notes** in **40 families** — one generated Markdown note per registered operator — plus **55 family guides**. **The notes are the knowledge base**: retrieve first, then write code.
