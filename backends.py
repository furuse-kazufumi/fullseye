...
def build(Op, IMAGE, REGION, FEATURE, CONTOUR, norm, binm):
    ...
    try:
        ...
        sk = [
            ...
            # more image->image
            ("sk_lbp", "texture", "local_binary_pattern", IMAGE, IMAGE,
            ...
            ("sk_enhance_contrast", "gray", "enhance_contrast", IMAGE, IMAGE,
            ...
            ("sk_shape_index", "texture", "curvature", IMAGE, IMAGE,
             lambda v, a, b: norm(np.nan_to_num(feature.shape_index(v, sigma=0.5 + 2.0 * a)))),
            ("sk_hessian_det", "edges", "hessian", IMAGE, IMAGE,
            ...
            ("sk_rolling_ball", "smoothing", "estimate_background", IMAGE, IMAGE,
             lambda v, a, b: np.clip(v - restoration.rolling_ball(v, radius=5 + int(a * 20)), 0, 1)),
            ("sk_nlm", "smoothing", "nl_means", IMAGE, IMAGE,
             lambda v, a, b: restoration.denoise_nl_means(v, patch_size=5, h=0.02 + 0.2 * a)),
            ("sk_tv_bregman", "smoothing", "tv_denoise", IMAGE, IMAGE,
            ...
            ("sk_clear_border", "region", "clear_border", REGION, REGION,
            ...
            ("sk_entropy_feat", "features", "entropy", IMAGE, FEATURE,
             lambda v, a, b: np.float64(measure.shannon_entropy(v))),
            ("sk_blur_effect", "features", "estimate_sharpness", IMAGE, FEATURE,
    ...
    try:
        ...
        cv = [
            ...
            ("cv_precorner", "edges", "corner_detect", IMAGE, IMAGE,
             lambda v, a, b: norm(np.abs(cv2.preCornerDetect(v.astype(np.float32), 3)))),
            ("cv_nlmeans", "smoothing", "nl_means", IMAGE, IMAGE,
            ...
            ("cv_good_features", "features", "points_features", IMAGE, FEATURE,
