...
## PoC-Serie — 142 reale Aufgaben mit Grundwahrheit
...
**2,153 Operator-Notizen** (Aufrufform, Typvertrag, HALCON-Pendant, Literatur, Provenienz) und **56 Familien-Leitfäden**. Einstiegspunkte nach Dimension:

**Gemessene Abdeckung**: evolvierbare Ops 932/932, typisiertes Ledger 1200/1212, Fassade `fullseye.<name>` 596/1230 — **die Fassade ist erst zur Hälfte abgedeckt**.

**Gemessener Inhalt**: von 2158 Notizen verweisen **2101** auf mindestens ein lauffähiges Beispiel (57 ohne), **2124** haben einen Nutzungsabschnitt ab 120 Zeichen (34 nur eine Zeile). Die Struktur (Aufrufform, Typen, anschließbare Ops) haben alle 2158.
...
## Dokumentkarte — alle 204

Die vollständige Karte, damit **kein Dokument vom Index aus unerreichbar ist** (die 2,153 Operator-Notizen und 56 Familien-Leitfäden unter `docs/ops/` über den Operator-Abschnitt oben; Artikel über [articles/](articles/README.md)). **Die Texte sind überwiegend japanisch.**
