...
## PoC-Serie — 143 reale Aufgaben mit Grundwahrheit
...
**2,183 Operator-Notizen** (Aufrufform, Typvertrag, HALCON-Pendant, Literatur, Provenienz) und **57 Familien-Leitfäden**. Einstiegspunkte nach Dimension:

**Gemessene Abdeckung**: evolvierbare Ops 932/932, typisiertes Ledger 1230/1242, Fassade `fullseye.<name>` 596/1230 — **die Fassade ist erst zur Hälfte abgedeckt**.

**Gemessener Inhalt**: von 2188 Notizen verweisen **2126** auf mindestens ein lauffähiges Beispiel (62 ohne), **2135** haben einen Nutzungsabschnitt ab 120 Zeichen (53 nur eine Zeile). Die Struktur (Aufrufform, Typen, anschließbare Ops) haben alle 2188.
...
## Dokumentkarte — alle 205

Die vollständige Karte, damit **kein Dokument vom Index aus unerreichbar ist** (die 2,183 Operator-Notizen und 57 Familien-Leitfäden unter `docs/ops/` über den Operator-Abschnitt oben; Artikel über [articles/](articles/README.md)). **Die Texte sind überwiegend japanisch.**
