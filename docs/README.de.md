...
**2,039 Operator-Notizen** (Aufrufform, Typvertrag, HALCON-Pendant, Literatur, Provenienz) und **52 Familien-Leitfäden**. Einstiegspunkte nach Dimension:

**Gemessene Abdeckung**: evolvierbare Ops 931/931, typisiertes Ledger 1087/1099, Fassade `fullseye.<name>` 568/1202 — **die Fassade ist erst zur Hälfte abgedeckt**.

**Gemessener Inhalt**: von 2044 Notizen verweisen **1991** auf mindestens ein lauffähiges Beispiel (53 ohne), **2015** haben einen Nutzungsabschnitt ab 120 Zeichen (29 nur eine Zeile). Die Struktur (Aufrufform, Typen, anschließbare Ops) haben alle 2044.
...
Die vollständige Karte, damit **kein Dokument vom Index aus unerreichbar ist** (die 2,039 Operator-Notizen und 52 Familien-Leitfäden unter `docs/ops/` über den Operator-Abschnitt oben; Artikel über [articles/](articles/README.md)). **Die Texte sind überwiegend japanisch.**
