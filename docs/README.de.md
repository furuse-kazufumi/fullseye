...
## PoC-Serie — 138 reale Aufgaben mit Grundwahrheit
...
**2,111 Operator-Notizen** (Aufrufform, Typvertrag, HALCON-Pendant, Literatur, Provenienz) und **56 Familien-Leitfäden**. Einstiegspunkte nach Dimension:

**Gemessene Abdeckung**: evolvierbare Ops 931/931, typisiertes Ledger 1159/1171, Fassade `fullseye.<name>` 576/1210 — **die Fassade ist erst zur Hälfte abgedeckt**.

**Gemessener Inhalt**: von 2116 Notizen verweisen **2059** auf mindestens ein lauffähiges Beispiel (57 ohne), **2082** haben einen Nutzungsabschnitt ab 120 Zeichen (34 nur eine Zeile). Die Struktur (Aufrufform, Typen, anschließbare Ops) haben alle 2116.
...
| `math` | 35 | [INDEX](ops/math/INDEX.md) · [guide](ops/math/guides/math_metrology.md) |
...
| `printpath` | 17 | [INDEX](ops/printpath/INDEX.md) · [guide](ops/printpath/guides/printpath.md) |
...
## Dokumentkarte — alle 200

Die vollständige Karte, damit **kein Dokument vom Index aus unerreichbar ist** (die 2,111 Operator-Notizen und 56 Familien-Leitfäden unter `docs/ops/` über den Operator-Abschnitt oben; Artikel über [articles/](articles/README.md)). **Die Texte sind überwiegend japanisch.**
