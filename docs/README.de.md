...
## PoC-Serie — 136 reale Aufgaben mit Grundwahrheit
...
**2,094 Operator-Notizen** (Aufrufform, Typvertrag, HALCON-Pendant, Literatur, Provenienz) und **56 Familien-Leitfäden**. Einstiegspunkte nach Dimension:

**Gemessene Abdeckung**: evolvierbare Ops 931/931, typisiertes Ledger 1142/1154, Fassade `fullseye.<name>` 568/1202 — **die Fassade ist erst zur Hälfte abgedeckt**.

**Gemessener Inhalt**: von 2099 Notizen verweisen **2042** auf mindestens ein lauffähiges Beispiel (57 ohne), **2067** haben einen Nutzungsabschnitt ab 120 Zeichen (32 nur eine Zeile). Die Struktur (Aufrufform, Typen, anschließbare Ops) haben alle 2099.
...
Die vollständige Karte, damit **kein Dokument vom Index aus unerreichbar ist** (die 2,094 Operator-Notizen und 56 Familien-Leitfäden unter `docs/ops/` über den Operator-Abschnitt oben; Artikel über [articles/](articles/README.md)). **Die Texte sind überwiegend japanisch.**
