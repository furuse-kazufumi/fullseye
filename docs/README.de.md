...
## PoC-Serie — 137 reale Aufgaben mit Grundwahrheit
...
**2,103 Operator-Notizen** (Aufrufform, Typvertrag, HALCON-Pendant, Literatur, Provenienz) und **56 Familien-Leitfäden**. Einstiegspunkte nach Dimension:

**Gemessene Abdeckung**: evolvierbare Ops 931/931, typisiertes Ledger 1151/1163, Fassade `fullseye.<name>` 568/1202 — **die Fassade ist erst zur Hälfte abgedeckt**.

**Gemessener Inhalt**: von 2108 Notizen verweisen **2051** auf mindestens ein lauffähiges Beispiel (57 ohne), **2074** haben einen Nutzungsabschnitt ab 120 Zeichen (34 nur eine Zeile). Die Struktur (Aufrufform, Typen, anschließbare Ops) haben alle 2108.
...
## Dokumentkarte — alle 199

Die vollständige Karte, damit **kein Dokument vom Index aus unerreichbar ist** (die 2,103 Operator-Notizen und 56 Familien-Leitfäden unter `docs/ops/` über den Operator-Abschnitt oben; Artikel über [articles/](articles/README.md)). **Die Texte sind überwiegend japanisch.**
