...
## PoC-Serie — 130 reale Aufgaben mit Grundwahrheit
...
**Gemessener Inhalt**: von 2073 Notizen verweisen **2016** auf mindestens ein lauffähiges Beispiel (57 ohne), **2041** haben einen Nutzungsabschnitt ab 120 Zeichen (32 nur eine Zeile). Die Struktur (Aufrufform, Typen, anschließbare Ops) haben alle 2073.
