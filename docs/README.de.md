...
**Gemessener Inhalt**: von 2188 Notizen verweisen **2122** auf mindestens ein lauffähiges Beispiel (66 ohne), **2137** haben einen Nutzungsabschnitt ab 120 Zeichen (51 nur eine Zeile). Die Struktur (Aufrufform, Typen, anschließbare Ops) haben alle 2188.
