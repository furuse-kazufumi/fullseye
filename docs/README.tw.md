...
**實測涵蓋**: 演化運算子 931/931、型別台帳 1050/1062、單行門面 `fullseye.<名稱>` 568/1201 —— **門面側僅涵蓋一半**。

**內容實測**: 2007 篇中，附有可執行範例的 **1966** 篇(41 篇沒有)，用法說明 120 字以上的 **1987** 篇(20 篇僅一行)。結構(呼叫形式、型別、可銜接運算子)2007 篇全有。
