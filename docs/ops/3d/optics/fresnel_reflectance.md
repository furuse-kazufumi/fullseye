...
- **呼び出し**: `import fullseye as fs; fs.ledger.fresnel_reflectance(cos_i, eta1=1.0, eta2=1.5)` (実装を直接呼ぶなら `import match3d; match3d.fresnel_reflectance(cos_i, eta1=1.0, eta2=1.5)`、台帳から引くなら `ops3d.get("fresnel_reflectance")`)
