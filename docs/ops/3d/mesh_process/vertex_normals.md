...
- **データ種**: `mesh` → `normals`
- **呼び出し**: `import mesh_props; mesh_props.vertex_normals(mesh) -> 'np.ndarray'` (または `ops3d.get("vertex_normals")`)
...
[laplacian_smooth](laplacian_smooth.md) · [taubin_smooth](taubin_smooth.md) · [decimate_qem](decimate_qem.md) · [face_normals](face_normals.md) · [mesh_area](mesh_area.md) · [vertex_curvature](vertex_curvature.md)
