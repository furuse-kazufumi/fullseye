...
- **呼び出し**: `import fullseye as fs; fs.ledger.line_from_2points(a, b)` (実装を直接呼ぶなら `import match3d; match3d.line_from_2points(a, b)`、台帳から引くなら `ops3d.get("line_from_2points")`)
