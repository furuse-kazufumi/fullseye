...
- **呼び出し**: `import fullseye as fs; fs.ledger.smallest_box3(points) -> 'dict'` (実装を直接呼ぶなら `import measure3d; measure3d.smallest_box3(points) -> 'dict'`、台帳から引くなら `ops3d.get("smallest_box3")`)
