...
- **呼び出し**: `import fullseye as fs; fs.ledger.fit_circle3(points) -> 'dict'` (実装を直接呼ぶなら `import measure3d; measure3d.fit_circle3(points) -> 'dict'`、台帳から引くなら `ops3d.get("fit_circle3")`)
