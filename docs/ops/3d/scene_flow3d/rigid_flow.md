...
- **呼び出し**: `import fullseye as fs; fs.ledger.rigid_flow(pts0, pts1, max_iter: 'int' = 20) -> 'dict'` (実装を直接呼ぶなら `import scene_flow3d; scene_flow3d.rigid_flow(pts0, pts1, max_iter: 'int' = 20) -> 'dict'`、台帳から引くなら `ops3d.get("rigid_flow")`)
