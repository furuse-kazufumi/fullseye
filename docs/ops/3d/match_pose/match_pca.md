...
- **呼び出し**: `import fullseye as fs; fs.ledger.match_pca(pts_scene, pts_model)` (実装を直接呼ぶなら `import match3d; match3d.match_pca(pts_scene, pts_model)`、台帳から引くなら `ops3d.get("match_pca")`)
