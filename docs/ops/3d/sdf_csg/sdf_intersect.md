...
- **データ種**: `sdf × sdf` → `sdf`
- **呼び出し**: `import sdf_ops; sdf_ops.sdf_intersect(a, b)` (または `ops3d.get("sdf_intersect")`)
...
[sphere_sdf](sphere_sdf.md) · [box_sdf](box_sdf.md) · [sdf_union](sdf_union.md) · [sdf_subtract](sdf_subtract.md) · [sdf_smooth_union](sdf_smooth_union.md) · [sdf_offset](sdf_offset.md)
