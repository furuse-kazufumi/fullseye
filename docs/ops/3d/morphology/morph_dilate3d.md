...
- **データ種**: `voxel` → `voxel`
- **呼び出し**: `import match3d; match3d.morph_dilate3d(vol, r=1, device='cpu')` (または `ops3d.get("morph_dilate3d")`)
...
[morph_erode3d](morph_erode3d.md) · [morph_gradient3d](morph_gradient3d.md) · [morph_tophat3d](morph_tophat3d.md) · [morph_blackhat3d](morph_blackhat3d.md)
