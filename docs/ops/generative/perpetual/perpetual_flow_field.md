...
- **呼び出し**: `import fullseye as fs; fs.ledger.perpetual_flow_field(size: 'int' = 520, seed: 'int' = 0, lines: 'int' = 420, steps: 'int' = 150, scale: 'float' = 0.01) -> 'np.ndarray'` (実装を直接呼ぶなら `import perpetual; perpetual.perpetual_flow_field(size: 'int' = 520, seed: 'int' = 0, lines: 'int' = 420, steps: 'int' = 150, scale: 'float' = 0.01) -> 'np.ndarray'`、台帳から引くなら `opsgenerative.get("perpetual_flow_field")`)
