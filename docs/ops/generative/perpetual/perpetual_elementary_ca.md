...
- **呼び出し**: `import fullseye as fs; fs.ledger.perpetual_elementary_ca(rule: 'int' = 90, width: 'int' = 401, rows: 'int' = 200, seed: 'int' = -1, cell: 'int' = 2) -> 'np.ndarray'` (実装を直接呼ぶなら `import perpetual; perpetual.perpetual_elementary_ca(rule: 'int' = 90, width: 'int' = 401, rows: 'int' = 200, seed: 'int' = -1, cell: 'int' = 2) -> 'np.ndarray'`、台帳から引くなら `opsgenerative.get("perpetual_elementary_ca")`)
