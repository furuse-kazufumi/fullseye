...
- **呼び出し**: `import fullseye as fs; fs.ledger.perpetual_chaos_game(points: 'int' = 400000, size: 'int' = 520, seed: 'int' = 0, vertices: 'int' = 3, ratio: 'float' = 0.5) -> 'np.ndarray'` (実装を直接呼ぶなら `import perpetual; perpetual.perpetual_chaos_game(points: 'int' = 400000, size: 'int' = 520, seed: 'int' = 0, vertices: 'int' = 3, ratio: 'float' = 0.5) -> 'np.ndarray'`、台帳から引くなら `opsgenerative.get("perpetual_chaos_game")`)
