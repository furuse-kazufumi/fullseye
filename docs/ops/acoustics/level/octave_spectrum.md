...
in: signal
out: table
examples: [acoustic_condition_monitoring, poc_rail_corrugation]
...
- [poc_rail_corrugation](../../../../examples/poc_rail_corrugation.py) — `py -3.11 examples/poc_rail_corrugation.py`
