...
- **呼び出し**: `import fullseye as fs; fs.ledger.poly_eval(coeffs, x)` (実装を直接呼ぶなら `import mathops; mathops.poly_eval(coeffs, x)`、台帳から引くなら `opsmath.get("poly_eval")`)
...
[mat_solve](../linalg/mat_solve.md) · [mat_lstsq](../linalg/mat_lstsq.md) · [stat_describe](../stats/stat_describe.md) · [stat_histogram](../stats/stat_histogram.md) · [stat_zscore](../stats/stat_zscore.md) · [interp_linear](interp_linear.md) · [interp_cubic](interp_cubic.md) · [interp_scattered](interp_scattered.md)

## 同カテゴリ(`interp_poly`)

[interp_linear](interp_linear.md) · [interp_cubic](interp_cubic.md) · [interp_scattered](interp_scattered.md) · [poly_fit](poly_fit.md) · [poly_roots](poly_roots.md)
