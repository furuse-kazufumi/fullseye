...
in: matrix
out: matrix
examples: [math_metrology, poc_colocalization_crosstalk, poc_ct_fidelity]
...
[mat_solve](../linalg/mat_solve.md) · [mat_lstsq](../linalg/mat_lstsq.md) · [mat_svd](../linalg/mat_svd.md) · [mat_eigh](../linalg/mat_eigh.md) · [mat_pinv](../linalg/mat_pinv.md) · [mat_cond](../linalg/mat_cond.md) · [stat_covariance](stat_covariance.md)

## 同カテゴリ(`stats`)

[stat_describe](stat_describe.md) · [stat_histogram](stat_histogram.md) · [stat_covariance](stat_covariance.md) · [stat_zscore](stat_zscore.md)
