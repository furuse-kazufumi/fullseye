...
# xpil_find_edges — 2D `edges` op

- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "xpil_find_edges", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![xpil_find_edges: input → output](../../_fig/xpil_find_edges.png)
...
![xpil_find_edges: other inputs](../../_fig/xpil_find_edges.inputs.jpg)
