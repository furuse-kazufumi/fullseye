...
![xwt_hf_reconstruct: input → output](../../_fig/xwt_hf_reconstruct.png)
...
![xwt_hf_reconstruct: other inputs](../../_fig/xwt_hf_reconstruct.inputs.jpg)
