...
# xkor_dog — 2D `edges` op

- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "xkor_dog", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![xkor_dog: input → output](../../_fig/xkor_dog.png)
...
![xkor_dog: other inputs](../../_fig/xkor_dog.inputs.jpg)
