...
# sobel_mag — 2D `edges` op

- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "sobel_mag", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)
- **HALCON 相当**: `sobel_amp`(意味・パラメータは HALCON リファレンスが参考になる)

![sobel_mag: input → output](../../_fig/sobel_mag.png)
...
![sobel_mag: other inputs](../../_fig/sobel_mag.inputs.jpg)
...
[prewitt_mag](prewitt_mag.md) · [roberts_mag](roberts_mag.md) · [dog](dog.md) · [edge_transition_width](edge_transition_width.md) · [grad_dir](grad_dir.md) · [log](log.md) · [corner_response](corner_response.md) · [sk_scharr](sk_scharr.md)
