...
# xsk2_corner_kr — 2D `edges` op

- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "xsk2_corner_kr", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![xsk2_corner_kr: input → output](../../_fig/xsk2_corner_kr.png)
...
![xsk2_corner_kr: other inputs](../../_fig/xsk2_corner_kr.inputs.jpg)
