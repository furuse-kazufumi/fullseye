...
# xsk3_corner_moravec — 2D `edges` op

- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "xsk3_corner_moravec", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![xsk3_corner_moravec: input → output](../../_fig/xsk3_corner_moravec.png)
...
![xsk3_corner_moravec: knob a sweep](../../_fig/xsk3_corner_moravec.a.jpg)

*つまみ b は出力を変えない(実測: 0.1 / 0.5 / 0.9 で同一)。*

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![xsk3_corner_moravec: other inputs](../../_fig/xsk3_corner_moravec.inputs.jpg)
