---
op: points_harris_binomial
dim: 2d
category: edges
in: image
out: image
halcon: points_harris_binomial
...
# points_harris_binomial — 2D `edges` op

- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "points_harris_binomial", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)
- **HALCON 相当**: `points_harris_binomial`(意味・パラメータは HALCON リファレンスが参考になる)

![points_harris_binomial: input → output](../../_fig/points_harris_binomial.png)
...
![points_harris_binomial: knob a sweep](../../_fig/points_harris_binomial.a.jpg)

**つまみ b を振る**(0.1 / 0.5 / 0.9、もう一方は既定):

![points_harris_binomial: knob b sweep](../../_fig/points_harris_binomial.b.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![points_harris_binomial: other inputs](../../_fig/points_harris_binomial.inputs.jpg)
