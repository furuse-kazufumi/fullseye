...
![edges_color: input → output](../../_fig/edges_color.png)
...
![edges_color: stages](../../_fig/edges_color.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![edges_color: other inputs](../../_fig/edges_color.inputs.jpg)
