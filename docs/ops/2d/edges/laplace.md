...
out: image
halcon: laplace
examples: [gallery2d_edges, poc_focus_stacking, poc_search_sweep_width, poc_white_balance]
...
![laplace: input → output](../../_fig/laplace.png)
...
![laplace: other inputs](../../_fig/laplace.inputs.jpg)
