...
![xsk_hessian_eig: input → output](../../_fig/xsk_hessian_eig.png)
...
![xsk_hessian_eig: knob a sweep](../../_fig/xsk_hessian_eig.a.jpg)

*つまみ b は出力を変えない(実測: 0.1 / 0.5 / 0.9 で同一)。*

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![xsk_hessian_eig: other inputs](../../_fig/xsk_hessian_eig.inputs.jpg)
