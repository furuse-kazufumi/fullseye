...
# sk_hessian_det — 2D `edges` op

- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "sk_hessian_det", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![sk_hessian_det: input → output](../../_fig/sk_hessian_det.png)
...
![sk_hessian_det: knob a sweep](../../_fig/sk_hessian_det.a.jpg)

*つまみ b は出力を変えない(実測: 0.1 / 0.5 / 0.9 で同一)。*

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![sk_hessian_det: other inputs](../../_fig/sk_hessian_det.inputs.jpg)
