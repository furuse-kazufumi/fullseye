...
# tf_phase_congruency — 2D `edges` op

- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "tf_phase_congruency", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![tf_phase_congruency: input → output](../../_fig/tf_phase_congruency.png)
...
![tf_phase_congruency: knob a sweep](../../_fig/tf_phase_congruency.a.jpg)

**つまみ b を振る**(0.1 / 0.5 / 0.9、もう一方は既定):

![tf_phase_congruency: knob b sweep](../../_fig/tf_phase_congruency.b.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![tf_phase_congruency: other inputs](../../_fig/tf_phase_congruency.inputs.jpg)
