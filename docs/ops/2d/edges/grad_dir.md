...
![grad_dir: input → output](../../_fig/grad_dir.png)
...
![grad_dir: other inputs](../../_fig/grad_dir.inputs.jpg)
...
[sobel_mag](sobel_mag.md) · [prewitt_mag](prewitt_mag.md) · [roberts_mag](roberts_mag.md) · [dog](dog.md) · [edge_transition_width](edge_transition_width.md) · [log](log.md) · [corner_response](corner_response.md) · [sk_scharr](sk_scharr.md)
