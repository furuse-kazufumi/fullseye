...
![roberts_mag: input → output](../../_fig/roberts_mag.png)
...
![roberts_mag: other inputs](../../_fig/roberts_mag.inputs.jpg)
...
[sobel_mag](sobel_mag.md) · [prewitt_mag](prewitt_mag.md) · [dog](dog.md) · [edge_transition_width](edge_transition_width.md) · [grad_dir](grad_dir.md) · [log](log.md) · [corner_response](corner_response.md) · [sk_scharr](sk_scharr.md)
