---
op: xsitk_minmax_curv_flow
dim: 2d
category: extra
in: image
out: image
examples: [gallery2d_color_artistic, genspark_external_review]
author: Kazufumi Furuse
license: Apache-2.0
version: 0.2.1  # fullseye lib version this note was generated for
---

# xsitk_minmax_curv_flow — 2D `extra` op

- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "xsitk_minmax_curv_flow", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![xsitk_minmax_curv_flow: input → output](../../_fig/xsitk_minmax_curv_flow.png)
...
![xsitk_minmax_curv_flow: knob a sweep](../../_fig/xsitk_minmax_curv_flow.a.jpg)

**つまみ b を振る**(0.1 / 0.5 / 0.9、もう一方は既定):

![xsitk_minmax_curv_flow: knob b sweep](../../_fig/xsitk_minmax_curv_flow.b.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![xsitk_minmax_curv_flow: other inputs](../../_fig/xsitk_minmax_curv_flow.inputs.jpg)
...
```program
xsitk_minmax_curv_flow 0.50 0.50
```
