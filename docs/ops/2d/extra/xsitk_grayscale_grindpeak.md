---
op: xsitk_grayscale_grindpeak
dim: 2d
category: extra
in: image
out: image
examples: [gallery2d_color_artistic, poc_weld_radiograph_porosity]
author: Kazufumi Furuse
license: Apache-2.0
version: 0.1.11  # fullseye lib version this note was generated for
---

# xsitk_grayscale_grindpeak — 2D `extra` op

- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "xsitk_grayscale_grindpeak", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![xsitk_grayscale_grindpeak: input → output](../../_fig/xsitk_grayscale_grindpeak.png)
...
![xsitk_grayscale_grindpeak: other inputs](../../_fig/xsitk_grayscale_grindpeak.inputs.jpg)
