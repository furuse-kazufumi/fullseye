...
- **データ種**: `points` → `points`
- **呼び出し**: `fullseye.apply(img, "tb_random_scale", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![tb_random_scale: input → output](../../_fig/tb_random_scale.png)
...
![tb_random_scale: stages](../../_fig/tb_random_scale.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![tb_random_scale: other inputs](../../_fig/tb_random_scale.inputs.jpg)
