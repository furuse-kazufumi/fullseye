...
# tb_cx_log_magnitude — 2D `typed` op

- **データ種**: `cimage` → `image`
- **呼び出し**: `fullseye.apply(img, "tb_cx_log_magnitude", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![tb_cx_log_magnitude: input → output](../../_fig/tb_cx_log_magnitude.png)
...
![tb_cx_log_magnitude: stages](../../_fig/tb_cx_log_magnitude.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![tb_cx_log_magnitude: other inputs](../../_fig/tb_cx_log_magnitude.inputs.jpg)
