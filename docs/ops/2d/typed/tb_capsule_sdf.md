...
![tb_capsule_sdf: input → output](../../_fig/tb_capsule_sdf.png)
...
![tb_capsule_sdf: stages](../../_fig/tb_capsule_sdf.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![tb_capsule_sdf: other inputs](../../_fig/tb_capsule_sdf.inputs.jpg)

**動き**(GIF: フレーム / 視点 / スライスを順に。静止の図が完成形で、GIF は補助):

![tb_capsule_sdf: animation](../../_fig/tb_capsule_sdf.gif)
