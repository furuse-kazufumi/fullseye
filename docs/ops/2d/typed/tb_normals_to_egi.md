...
*図なし: 走らせたが落ちた —— ValueError: text '(a) b=0.1' does not fit in 36px even at font size 9 — shorten it, widen the box, or lower min_font_size (truncating it silently is not an option: a machin*
