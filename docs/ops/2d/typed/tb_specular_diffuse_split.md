...
![tb_specular_diffuse_split: input → output](../../_fig/tb_specular_diffuse_split.png)
...
![tb_specular_diffuse_split: stages](../../_fig/tb_specular_diffuse_split.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![tb_specular_diffuse_split: other inputs](../../_fig/tb_specular_diffuse_split.inputs.jpg)
...
tb_specular_diffuse_split 0.50 0.50
```
