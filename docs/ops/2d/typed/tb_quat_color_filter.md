...
![tb_quat_color_filter: input → output](../../_fig/tb_quat_color_filter.png)
...
![tb_quat_color_filter: stages](../../_fig/tb_quat_color_filter.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![tb_quat_color_filter: other inputs](../../_fig/tb_quat_color_filter.inputs.jpg)
