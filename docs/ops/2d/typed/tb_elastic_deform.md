...
![tb_elastic_deform: input → output](../../_fig/tb_elastic_deform.png)
...
![tb_elastic_deform: stages](../../_fig/tb_elastic_deform.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![tb_elastic_deform: other inputs](../../_fig/tb_elastic_deform.inputs.jpg)
