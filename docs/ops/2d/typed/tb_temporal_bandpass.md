...
![tb_temporal_bandpass: input → output](../../_fig/tb_temporal_bandpass.png)
...
![tb_temporal_bandpass: stages](../../_fig/tb_temporal_bandpass.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![tb_temporal_bandpass: other inputs](../../_fig/tb_temporal_bandpass.inputs.jpg)

**動き**(GIF: フレーム / 視点 / スライスを順に。静止の図が完成形で、GIF は補助):

![tb_temporal_bandpass: animation](../../_fig/tb_temporal_bandpass.gif)
