...
[identity](../misc/identity.md) · [tb_mat_pinv](tb_mat_pinv.md) · [tb_mat_cond](tb_mat_cond.md) · [tb_stat_correlation](tb_stat_correlation.md) · [matrix_to_img](../bridge/matrix_to_img.md)
