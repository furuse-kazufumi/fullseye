...
![tb_fmcw_window_apply: input → output](../../_fig/tb_fmcw_window_apply.png)
...
![tb_fmcw_window_apply: stages](../../_fig/tb_fmcw_window_apply.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![tb_fmcw_window_apply: other inputs](../../_fig/tb_fmcw_window_apply.inputs.jpg)
