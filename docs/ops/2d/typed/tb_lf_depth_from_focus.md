...
![tb_lf_depth_from_focus: input → output](../../_fig/tb_lf_depth_from_focus.png)
...
![tb_lf_depth_from_focus: stages](../../_fig/tb_lf_depth_from_focus.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![tb_lf_depth_from_focus: other inputs](../../_fig/tb_lf_depth_from_focus.inputs.jpg)
