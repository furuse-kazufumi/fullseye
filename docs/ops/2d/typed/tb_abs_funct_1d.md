...
# tb_abs_funct_1d — 2D `typed` op

- **データ種**: `signal` → `signal`
- **呼び出し**: `fullseye.apply(img, "tb_abs_funct_1d", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![tb_abs_funct_1d: input → output](../../_fig/tb_abs_funct_1d.png)
...
![tb_abs_funct_1d: stages](../../_fig/tb_abs_funct_1d.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![tb_abs_funct_1d: other inputs](../../_fig/tb_abs_funct_1d.inputs.jpg)
