...
![tb_tcspc_coates_correct: input → output](../../_fig/tb_tcspc_coates_correct.png)
...
![tb_tcspc_coates_correct: stages](../../_fig/tb_tcspc_coates_correct.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![tb_tcspc_coates_correct: other inputs](../../_fig/tb_tcspc_coates_correct.inputs.jpg)
