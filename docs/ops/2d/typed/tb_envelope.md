...
# tb_envelope — 2D `typed` op

- **データ種**: `signal` → `signal`
- **呼び出し**: `fullseye.apply(img, "tb_envelope", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![tb_envelope: input → output](../../_fig/tb_envelope.png)
...
![tb_envelope: stages](../../_fig/tb_envelope.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![tb_envelope: other inputs](../../_fig/tb_envelope.inputs.jpg)
