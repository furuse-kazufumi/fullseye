...
out: image
halcon: log_image
examples: [gallery2d_gray_arith, poc_weld_radiograph_porosity]
author: Kazufumi Furuse
license: Apache-2.0
version: 0.1.11  # fullseye lib version this note was generated for
---

# log_image — 2D `arithmetic` op

- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "log_image", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)
- **HALCON 相当**: `log_image`(意味・パラメータは HALCON リファレンスが参考になる)

![log_image: input → output](../../_fig/log_image.png)
...
![log_image: other inputs](../../_fig/log_image.inputs.jpg)
...
[abs_image](abs_image.md) · [sqrt_image](sqrt_image.md) · [exp_image](exp_image.md) · [sin_image](sin_image.md) · [cos_image](cos_image.md) · [asin_image](asin_image.md) · [acos_image](acos_image.md) · [atan_image](atan_image.md)
