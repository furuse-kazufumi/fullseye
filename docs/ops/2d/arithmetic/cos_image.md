...
- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "cos_image", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)
- **HALCON 相当**: `cos_image`(意味・パラメータは HALCON リファレンスが参考になる)

![cos_image: input → output](../../_fig/cos_image.png)
...
![cos_image: other inputs](../../_fig/cos_image.inputs.jpg)
...
[abs_image](abs_image.md) · [sqrt_image](sqrt_image.md) · [exp_image](exp_image.md) · [log_image](log_image.md) · [sin_image](sin_image.md) · [asin_image](asin_image.md) · [acos_image](acos_image.md) · [atan_image](atan_image.md)
