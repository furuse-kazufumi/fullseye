...
- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "abs_image", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)
- **HALCON 相当**: `abs_image`(意味・パラメータは HALCON リファレンスが参考になる)

![abs_image: input → output](../../_fig/abs_image.png)
...
![abs_image: other inputs](../../_fig/abs_image.inputs.jpg)
...
[sqrt_image](sqrt_image.md) · [exp_image](exp_image.md) · [log_image](log_image.md) · [sin_image](sin_image.md) · [cos_image](cos_image.md) · [asin_image](asin_image.md) · [acos_image](acos_image.md) · [atan_image](atan_image.md)
