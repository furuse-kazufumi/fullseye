...
# ph_heat_flow — 2D `physics` op

- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "ph_heat_flow", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![ph_heat_flow: input → output](../../_fig/ph_heat_flow.png)
...
![ph_heat_flow: knob a sweep](../../_fig/ph_heat_flow.a.jpg)

*つまみ b は出力を変えない(実測: 0.1 / 0.5 / 0.9 で同一)。*

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![ph_heat_flow: other inputs](../../_fig/ph_heat_flow.inputs.jpg)
...
[ph_perona_malik](ph_perona_malik.md) · [ph_coherence_enhancing_diffusion](ph_coherence_enhancing_diffusion.md) · [ph_reaction_diffusion](ph_reaction_diffusion.md) · [ph_mean_curvature_motion](ph_mean_curvature_motion.md) · [ph_total_variation_flow](ph_total_variation_flow.md)
