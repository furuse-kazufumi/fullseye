...
![ph_coherence_enhancing_diffusion: input → output](../../_fig/ph_coherence_enhancing_diffusion.png)
...
![ph_coherence_enhancing_diffusion: knob a sweep](../../_fig/ph_coherence_enhancing_diffusion.a.jpg)

**つまみ b を振る**(0.1 / 0.5 / 0.9、もう一方は既定):

![ph_coherence_enhancing_diffusion: knob b sweep](../../_fig/ph_coherence_enhancing_diffusion.b.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![ph_coherence_enhancing_diffusion: other inputs](../../_fig/ph_coherence_enhancing_diffusion.inputs.jpg)
