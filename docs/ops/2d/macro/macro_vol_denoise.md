...
# macro_vol_denoise — 2D `macro` op

- **データ種**: `volume` → `volume`
- **呼び出し**: `fullseye.apply(img, "macro_vol_denoise", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![macro_vol_denoise: input → output](../../_fig/macro_vol_denoise.png)
...
![macro_vol_denoise: stages](../../_fig/macro_vol_denoise.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![macro_vol_denoise: other inputs](../../_fig/macro_vol_denoise.inputs.jpg)

**動き**(GIF: フレーム / 視点 / スライスを順に。静止の図が完成形で、GIF は補助):

![macro_vol_denoise: animation](../../_fig/macro_vol_denoise.gif)
...
[macro_denoise](macro_denoise.md) · [macro_edge](macro_edge.md) · [macro_binarize](macro_binarize.md)
