...
![vol_median: input → output](../../_fig/vol_median.png)
...
![vol_median: stages](../../_fig/vol_median.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![vol_median: other inputs](../../_fig/vol_median.inputs.jpg)

**動き**(GIF: フレーム / 視点 / スライスを順に。静止の図が完成形で、GIF は補助):

![vol_median: animation](../../_fig/vol_median.gif)
