...
out: image
halcon: gauss_filter
examples: [coherence_scanning, color_transport, ct_inspection, gallery2d_smoothing_rank, photon_timeresolved, poc_interferometry_step, quickstart, video_streaming]
