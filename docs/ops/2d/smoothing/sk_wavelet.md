...
![sk_wavelet: input → output](../../_fig/sk_wavelet.png)
...
![sk_wavelet: other inputs](../../_fig/sk_wavelet.inputs.jpg)
...
[gaussian](gaussian.md) · [mean_box](mean_box.md) · [bilateral](bilateral.md) · [unsharp](unsharp.md) · [sk_tv](sk_tv.md) · [sk_rolling_ball](sk_rolling_ball.md) · [sk_nlm](sk_nlm.md) · [sk_tv_bregman](sk_tv_bregman.md)
