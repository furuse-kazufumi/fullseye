...
# xcv3_pyr_laplacian — 2D `smoothing` op

- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "xcv3_pyr_laplacian", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![xcv3_pyr_laplacian: input → output](../../_fig/xcv3_pyr_laplacian.png)
...
![xcv3_pyr_laplacian: knob a sweep](../../_fig/xcv3_pyr_laplacian.a.jpg)

*つまみ b は出力を変えない(実測: 0.1 / 0.5 / 0.9 で同一)。*

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![xcv3_pyr_laplacian: other inputs](../../_fig/xcv3_pyr_laplacian.inputs.jpg)
