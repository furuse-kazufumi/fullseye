...
- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "xsk2_radon", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![xsk2_radon: input → output](../../_fig/xsk2_radon.png)
...
![xsk2_radon: other inputs](../../_fig/xsk2_radon.inputs.jpg)
