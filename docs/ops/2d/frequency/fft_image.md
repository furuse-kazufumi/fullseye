...
- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "fft_image", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)
- **HALCON 相当**: `fft_image`(意味・パラメータは HALCON リファレンスが参考になる)

![fft_image: input → output](../../_fig/fft_image.png)
...
![fft_image: other inputs](../../_fig/fft_image.inputs.jpg)
...
[lowpass](lowpass.md) · [highpass](highpass.md) · [sk_butterworth](sk_butterworth.md) · [power_real](power_real.md) · [power_byte](power_byte.md) · [phase_rad](phase_rad.md) · [highpass_image](highpass_image.md) · [bandpass_image](bandpass_image.md)
