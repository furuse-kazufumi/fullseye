...
![gen_contour_region_xld: input → output](../../_fig/gen_contour_region_xld.png)
...
![gen_contour_region_xld: stages](../../_fig/gen_contour_region_xld.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![gen_contour_region_xld: other inputs](../../_fig/gen_contour_region_xld.inputs.jpg)
...
```program
threshold 0.50 0.50
gen_contour_region_xld 0.50 0.50
```
