...
![close_contours_xld: input → output](../../_fig/close_contours_xld.png)
...
![close_contours_xld: stages](../../_fig/close_contours_xld.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![close_contours_xld: other inputs](../../_fig/close_contours_xld.inputs.jpg)
