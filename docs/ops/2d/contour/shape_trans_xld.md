...
![shape_trans_xld: input → output](../../_fig/shape_trans_xld.png)
...
![shape_trans_xld: stages](../../_fig/shape_trans_xld.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![shape_trans_xld: other inputs](../../_fig/shape_trans_xld.inputs.jpg)
