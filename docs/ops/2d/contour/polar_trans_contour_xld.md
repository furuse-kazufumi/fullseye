...
![polar_trans_contour_xld: input → output](../../_fig/polar_trans_contour_xld.png)
...
![polar_trans_contour_xld: stages](../../_fig/polar_trans_contour_xld.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![polar_trans_contour_xld: other inputs](../../_fig/polar_trans_contour_xld.inputs.jpg)
...
polar_trans_contour_xld 0.50 0.50
```
