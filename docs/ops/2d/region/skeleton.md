...
- **データ種**: `region` → `region`
- **呼び出し**: `fullseye.apply(img, "skeleton", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)
- **HALCON 相当**: `skeleton`(意味・パラメータは HALCON リファレンスが参考になる)

![skeleton: input → output](../../_fig/skeleton.png)
...
![skeleton: stages](../../_fig/skeleton.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![skeleton: other inputs](../../_fig/skeleton.inputs.jpg)
