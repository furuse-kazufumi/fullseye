...
![fill_up_shape: input → output](../../_fig/fill_up_shape.png)
...
![fill_up_shape: stages](../../_fig/fill_up_shape.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![fill_up_shape: other inputs](../../_fig/fill_up_shape.inputs.jpg)
