---
op: r3_select_region_point
dim: 2d
category: region
in: region
out: region
halcon: select_region_point
...
# r3_select_region_point — 2D `region` op

- **データ種**: `region` → `region`
- **呼び出し**: `fullseye.apply(img, "r3_select_region_point", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)
- **HALCON 相当**: `select_region_point`(意味・パラメータは HALCON リファレンスが参考になる)

![r3_select_region_point: input → output](../../_fig/r3_select_region_point.png)
...
![r3_select_region_point: knob b sweep](../../_fig/r3_select_region_point.b.jpg)

**段階**(前置きの op → この op。左から順):

![r3_select_region_point: stages](../../_fig/r3_select_region_point.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![r3_select_region_point: other inputs](../../_fig/r3_select_region_point.inputs.jpg)
...
```program
threshold 0.50 0.50
r3_select_region_point 0.50 0.50
```
