...
- **データ種**: `region` → `region`
- **呼び出し**: `fullseye.apply(img, "fill_up", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)
- **HALCON 相当**: `fill_up`(意味・パラメータは HALCON リファレンスが参考になる)

![fill_up: input → output](../../_fig/fill_up.png)
...
![fill_up: stages](../../_fig/fill_up.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![fill_up: other inputs](../../_fig/fill_up.inputs.jpg)
