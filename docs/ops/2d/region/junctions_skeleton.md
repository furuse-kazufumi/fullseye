---
op: junctions_skeleton
dim: 2d
category: region
in: region
out: region
halcon: junctions_skeleton
...
# junctions_skeleton — 2D `region` op
...
![junctions_skeleton: input → output](../../_fig/junctions_skeleton.png)
...
![junctions_skeleton: stages](../../_fig/junctions_skeleton.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![junctions_skeleton: other inputs](../../_fig/junctions_skeleton.inputs.jpg)
