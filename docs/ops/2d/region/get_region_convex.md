...
![get_region_convex: input → output](../../_fig/get_region_convex.png)
...
![get_region_convex: stages](../../_fig/get_region_convex.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![get_region_convex: other inputs](../../_fig/get_region_convex.inputs.jpg)
