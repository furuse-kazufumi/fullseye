...
![sk_find_boundaries: input → output](../../_fig/sk_find_boundaries.png)
...
![sk_find_boundaries: stages](../../_fig/sk_find_boundaries.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![sk_find_boundaries: other inputs](../../_fig/sk_find_boundaries.inputs.jpg)
