...
![em_skeleton: input → output](../../_fig/em_skeleton.png)
...
![em_skeleton: stages](../../_fig/em_skeleton.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![em_skeleton: other inputs](../../_fig/em_skeleton.inputs.jpg)
