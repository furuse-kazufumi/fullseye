...
![invert_region: input → output](../../_fig/invert_region.png)
...
![invert_region: stages](../../_fig/invert_region.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![invert_region: other inputs](../../_fig/invert_region.inputs.jpg)
