...
![r2_endpoints_skeleton: input → output](../../_fig/r2_endpoints_skeleton.png)
...
![r2_endpoints_skeleton: stages](../../_fig/r2_endpoints_skeleton.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![r2_endpoints_skeleton: other inputs](../../_fig/r2_endpoints_skeleton.inputs.jpg)
...
```program
threshold 0.50 0.50
r2_endpoints_skeleton 0.50 0.50
```
