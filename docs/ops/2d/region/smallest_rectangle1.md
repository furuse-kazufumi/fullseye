...
# smallest_rectangle1 — 2D `region` op

- **データ種**: `region` → `region`
- **呼び出し**: `fullseye.apply(img, "smallest_rectangle1", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)
- **HALCON 相当**: `smallest_rectangle1`(意味・パラメータは HALCON リファレンスが参考になる)

![smallest_rectangle1: input → output](../../_fig/smallest_rectangle1.png)
...
![smallest_rectangle1: stages](../../_fig/smallest_rectangle1.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![smallest_rectangle1: other inputs](../../_fig/smallest_rectangle1.inputs.jpg)
