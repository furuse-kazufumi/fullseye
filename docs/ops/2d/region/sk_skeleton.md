...
out: region
halcon: skeleton
examples: [gallery2d_region, poc_solar_el_inspection]
author: Kazufumi Furuse
license: Apache-2.0
version: 0.1.11  # fullseye lib version this note was generated for
---

# sk_skeleton — 2D `region` op

- **データ種**: `region` → `region`
- **呼び出し**: `fullseye.apply(img, "sk_skeleton", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)
- **HALCON 相当**: `skeleton`(意味・パラメータは HALCON リファレンスが参考になる)

![sk_skeleton: input → output](../../_fig/sk_skeleton.png)
...
![sk_skeleton: stages](../../_fig/sk_skeleton.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![sk_skeleton: other inputs](../../_fig/sk_skeleton.inputs.jpg)
