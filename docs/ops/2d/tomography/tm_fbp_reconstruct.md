...
# tm_fbp_reconstruct — 2D `tomography` op

- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "tm_fbp_reconstruct", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![tm_fbp_reconstruct: input → output](../../_fig/tm_fbp_reconstruct.png)
...
![tm_fbp_reconstruct: knob b sweep](../../_fig/tm_fbp_reconstruct.b.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![tm_fbp_reconstruct: other inputs](../../_fig/tm_fbp_reconstruct.inputs.jpg)
...
[tm_radon_forward](tm_radon_forward.md) · [tm_sart_reconstruct](tm_sart_reconstruct.md) · [tm_backproject_unfiltered](tm_backproject_unfiltered.md) · [tm_sinogram_denoise](tm_sinogram_denoise.md)
