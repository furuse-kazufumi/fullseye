...
# tm_backproject_unfiltered — 2D `tomography` op

- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "tm_backproject_unfiltered", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![tm_backproject_unfiltered: input → output](../../_fig/tm_backproject_unfiltered.png)
...
![tm_backproject_unfiltered: other inputs](../../_fig/tm_backproject_unfiltered.inputs.jpg)
...
[tm_radon_forward](tm_radon_forward.md) · [tm_fbp_reconstruct](tm_fbp_reconstruct.md) · [tm_sart_reconstruct](tm_sart_reconstruct.md) · [tm_sinogram_denoise](tm_sinogram_denoise.md)
