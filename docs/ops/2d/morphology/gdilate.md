...
# gdilate — 2D `morphology` op

- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "gdilate", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)
- **HALCON 相当**: `gray_dilation`(意味・パラメータは HALCON リファレンスが参考になる)

![gdilate: input → output](../../_fig/gdilate.png)
...
![gdilate: other inputs](../../_fig/gdilate.inputs.jpg)
...
[gerode](gerode.md) · [gopen](gopen.md) · [gclose](gclose.md) · [tophat](tophat.md) · [bothat](bothat.md) · [morph_grad](morph_grad.md) · [persistence_map](persistence_map.md) · [local_thickness](local_thickness.md)
