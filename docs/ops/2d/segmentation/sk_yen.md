...
- **データ種**: `image` → `region`
- **呼び出し**: `fullseye.apply(img, "sk_yen", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)
- **HALCON 相当**: `binary_threshold`(意味・パラメータは HALCON リファレンスが参考になる)

![sk_yen: input → output](../../_fig/sk_yen.png)
...
![sk_yen: other inputs](../../_fig/sk_yen.inputs.jpg)
...
[threshold](threshold.md) · [otsu](otsu.md) · [canny](canny.md) · [adaptive_gauss_thresh](adaptive_gauss_thresh.md) · [sk_otsu](sk_otsu.md) · [sk_li](sk_li.md) · [sk_sauvola](sk_sauvola.md) · [sk_niblack](sk_niblack.md)
