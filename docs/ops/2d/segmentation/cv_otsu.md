...
examples: [gallery2d_segmentation, poc_vegetation_cover, threshold_family_agreement]
...
![cv_otsu: input → output](../../_fig/cv_otsu.png)
...
![cv_otsu: other inputs](../../_fig/cv_otsu.inputs.jpg)
