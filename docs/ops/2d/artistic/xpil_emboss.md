...
# xpil_emboss — 2D `artistic` op

- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "xpil_emboss", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![xpil_emboss: input → output](../../_fig/xpil_emboss.png)
...
![xpil_emboss: other inputs](../../_fig/xpil_emboss.inputs.jpg)
...
[xcv_stylization](xcv_stylization.md) · [xcv_pencil_sketch](xcv_pencil_sketch.md)
