...
![xsp_detrend_flatten: input → output](../../_fig/xsp_detrend_flatten.png)
...
![xsp_detrend_flatten: other inputs](../../_fig/xsp_detrend_flatten.inputs.jpg)
