...
# xsk3_integral_image — 2D `gray` op

- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "xsk3_integral_image", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![xsk3_integral_image: input → output](../../_fig/xsk3_integral_image.png)
...
![xsk3_integral_image: other inputs](../../_fig/xsk3_integral_image.inputs.jpg)
