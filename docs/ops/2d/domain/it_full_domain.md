...
# it_full_domain — 2D `domain` op

- **データ種**: `image` → `image`
- **呼び出し**: `fullseye.apply(img, "it_full_domain", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![it_full_domain: input → output](../../_fig/it_full_domain.png)
...
![it_full_domain: other inputs](../../_fig/it_full_domain.inputs.jpg)
...
[it_crop_domain](it_crop_domain.md)
