...
![xmh_haar: input → output](../../_fig/xmh_haar.png)
...
![xmh_haar: other inputs](../../_fig/xmh_haar.inputs.jpg)
...
[xmh_daubechies](xmh_daubechies.md) · [tf_radon_sinogram](tf_radon_sinogram.md)
