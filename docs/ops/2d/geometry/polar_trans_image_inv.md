---
op: polar_trans_image_inv
dim: 2d
category: geometry
in: image
out: image
halcon: polar_trans_image_inv
...
![polar_trans_image_inv: input → output](../../_fig/polar_trans_image_inv.png)
...
![polar_trans_image_inv: other inputs](../../_fig/polar_trans_image_inv.inputs.jpg)
