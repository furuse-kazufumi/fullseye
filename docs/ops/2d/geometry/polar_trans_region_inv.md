...
# polar_trans_region_inv — 2D `geometry` op
...
![polar_trans_region_inv: input → output](../../_fig/polar_trans_region_inv.png)
...
![polar_trans_region_inv: stages](../../_fig/polar_trans_region_inv.chain.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![polar_trans_region_inv: other inputs](../../_fig/polar_trans_region_inv.inputs.jpg)
...
```program
threshold 0.50 0.50
polar_trans_region_inv 0.50 0.50
```
