...
![polar_trans_image_ext: input → output](../../_fig/polar_trans_image_ext.png)
...
![polar_trans_image_ext: other inputs](../../_fig/polar_trans_image_ext.inputs.jpg)
...
```program
polar_trans_image_ext 0.50 0.50
```
