...
![xsk_struct_coherence: input → output](../../_fig/xsk_struct_coherence.png)
...
![xsk_struct_coherence: knob a sweep](../../_fig/xsk_struct_coherence.a.jpg)

*つまみ b は出力を変えない(実測: 0.1 / 0.5 / 0.9 で同一)。*

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![xsk_struct_coherence: other inputs](../../_fig/xsk_struct_coherence.inputs.jpg)
