...
in: image
out: image
examples: [gallery2d_texture_freq, poc_fresco_craquelure]
...
![xsk_meijering: input → output](../../_fig/xsk_meijering.png)
...
![xsk_meijering: other inputs](../../_fig/xsk_meijering.inputs.jpg)
