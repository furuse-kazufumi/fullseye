...
![hx_gabor: input → output](../../_fig/hx_gabor.png)
...
![hx_gabor: knob a sweep](../../_fig/hx_gabor.a.jpg)

**つまみ b を振る**(0.1 / 0.5 / 0.9、もう一方は既定):

![hx_gabor: knob b sweep](../../_fig/hx_gabor.b.jpg)

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![hx_gabor: other inputs](../../_fig/hx_gabor.inputs.jpg)
