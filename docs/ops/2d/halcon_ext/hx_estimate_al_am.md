---
op: hx_estimate_al_am
dim: 2d
category: halcon_ext
in: image
out: feature
halcon: estimate_al_am
...
# hx_estimate_al_am — 2D `halcon_ext` op

- **データ種**: `image` → `feature`
- **呼び出し**: `fullseye.apply(img, "hx_estimate_al_am", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)
- **HALCON 相当**: `estimate_al_am`(意味・パラメータは HALCON リファレンスが参考になる)

![hx_estimate_al_am: input → output](../../_fig/hx_estimate_al_am.png)
