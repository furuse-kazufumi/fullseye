...
# xsk3_estimate_sigma — 2D `features` op

- **データ種**: `image` → `feature`
- **呼び出し**: `fullseye.apply(img, "xsk3_estimate_sigma", a=0.5, b=0.5)` (2-D は 1 画像 + 2 スカラつまみ `a,b∈[0,1]` のモデル)

![xsk3_estimate_sigma: input → output](../../_fig/xsk3_estimate_sigma.png)
