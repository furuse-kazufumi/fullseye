...
![hough_line_trans: input → output](../../_fig/hough_line_trans.png)
...
![hough_line_trans: knob a sweep](../../_fig/hough_line_trans.a.jpg)

*つまみ b は出力を変えない(実測: 0.1 / 0.5 / 0.9 で同一)。*

**別の画像でも**(合成シーン / 写真 / 硬貨。上段が入力、下段がその出力。つまみは既定):

![hough_line_trans: other inputs](../../_fig/hough_line_trans.inputs.jpg)
