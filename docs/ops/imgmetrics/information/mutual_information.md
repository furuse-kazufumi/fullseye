...
- **呼び出し**: `import fullseye as fs; fs.ledger.mutual_information(a, b, bins=64, data_range=None)` (実装を直接呼ぶなら `import imgmetrics; imgmetrics.mutual_information(a, b, bins=64, data_range=None)`、台帳から引くなら `opsimgmetrics.get("mutual_information")`)
