...
- **呼び出し**: `import fullseye as fs; fs.ledger.brewster_angle_deg(n1=1.0, n2=1.5) -> 'float'` (実装を直接呼ぶなら `import glassmirror; glassmirror.brewster_angle_deg(n1=1.0, n2=1.5) -> 'float'`、台帳から引くなら `opsoptics.get("brewster_angle_deg")`)
...
[fresnel_dielectric](fresnel_dielectric.md) · [fresnel_conductor](fresnel_conductor.md) · [critical_angle_deg](critical_angle_deg.md)
