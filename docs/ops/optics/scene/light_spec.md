...
- **データ種**: `` → `table`
- **呼び出し**: `import optscene; optscene.light_spec(kind: 'str' = 'coaxial', source: 'str' = 'led', wavelength_nm: 'float' = 550.0, bandwidth_nm: 'float' = 30.0, radius_mm: 'float' = 40.0, height_mm: 'float' = 110.0, size_mm: 'float' = None, n: 'int' = 196, intensity: 'float' = 1.0, cos_exponent: 'float' = 1.0, polarization: 'str' = None) -> 'dict'` (または `opsoptics.get("light_spec")`)
