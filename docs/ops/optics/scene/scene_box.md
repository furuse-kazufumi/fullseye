...
- **呼び出し**: `import fullseye as fs; fs.ledger.scene_box(center_mm, half_size_mm, material=None) -> 'dict'` (実装を直接呼ぶなら `import optscene; optscene.scene_box(center_mm, half_size_mm, material=None) -> 'dict'`、台帳から引くなら `opsoptics.get("scene_box")`)
...
[scene_material](scene_material.md) · [scene_plane](scene_plane.md) · [scene_sphere](scene_sphere.md) · [scene_cylinder](scene_cylinder.md) · [surface_defect](surface_defect.md) · [surface_finish](surface_finish.md) · [random_defects](random_defects.md) · [scene_difference](scene_difference.md)
