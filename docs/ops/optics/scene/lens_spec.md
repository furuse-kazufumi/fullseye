...
- **データ種**: `` → `table`
- **呼び出し**: `import optscene; optscene.lens_spec(focal_mm: 'float' = 25.0, f_number: 'float' = None, na: 'float' = None, working_distance_mm: 'float' = 200.0, coc_um: 'float' = None, telecentric: 'bool' = False, transmission: 'float' = 0.9) -> 'dict'` (または `opsoptics.get("lens_spec")`)
