...
[airy_pattern](airy_pattern.md) · [angular_spectrum_propagate](angular_spectrum_propagate.md) · [fraunhofer_pattern](fraunhofer_pattern.md) · [gaussian_beam](gaussian_beam.md) · [pupil_psf](pupil_psf.md) · [pupil_blur](pupil_blur.md)
