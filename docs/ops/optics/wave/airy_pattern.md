...
[fraunhofer_pattern](fraunhofer_pattern.md) · [pupil_psf](pupil_psf.md) · [pupil_blur](pupil_blur.md) · [psf_to_mtf](../imaging/psf_to_mtf.md) · [polarization_demosaic](../polarization/polarization_demosaic.md) · [polarization_demosaic_color](../polarization/polarization_demosaic_color.md) · [illumination_uniformity](../illumination/illumination_uniformity.md) · [render_through_lens](../imaging_sim/render_through_lens.md)

## 同カテゴリ(`wave`)

[angular_spectrum_propagate](angular_spectrum_propagate.md) · [fraunhofer_pattern](fraunhofer_pattern.md) · [fourier_plane_filter](fourier_plane_filter.md) · [four_f_filter](four_f_filter.md) · [gaussian_beam](gaussian_beam.md) · [defocus_from_shift](defocus_from_shift.md) · [pupil_psf](pupil_psf.md) · [pupil_blur](pupil_blur.md)
