...
[cie_xyz_from_wavelength](cie_xyz_from_wavelength.md) · [spectrum_to_srgb](spectrum_to_srgb.md) · [thin_film_reflectance](thin_film_reflectance.md) · [grating_rgb](grating_rgb.md) · [thin_film_rgb](thin_film_rgb.md) · [ward_anisotropic](ward_anisotropic.md)
