...
[clearcoat_shade](clearcoat_shade.md) · [defocus_blur](../scene/defocus_blur.md) · [diffraction_blur](../scene/diffraction_blur.md) · [sensor_capture](../scene/sensor_capture.md)

## 同カテゴリ(`material`)

[material_catalog](material_catalog.md) · [oren_nayar](oren_nayar.md) · [clearcoat_shade](clearcoat_shade.md) · [sheen_shade](sheen_shade.md) · [subsurface_approx](subsurface_approx.md)
