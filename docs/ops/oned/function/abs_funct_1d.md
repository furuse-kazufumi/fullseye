...
# abs_funct_1d — ONED `function` op

- **データ種**: `signal` → `signal`
- **呼び出し**: `import fullseye as fs; fs.ledger.abs_funct_1d(y)` (実装を直接呼ぶなら `import funct1d; funct1d.abs_funct_1d(y)`、台帳から引くなら `ops1d.get("abs_funct_1d")`)
