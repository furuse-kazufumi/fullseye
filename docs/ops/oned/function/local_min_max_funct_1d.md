---
op: local_min_max_funct_1d
dim: oned
category: function
in: signal
out: table
examples: [poc_web_roll_periodicity, signal_funct1d]
author: Kazufumi Furuse
license: Apache-2.0
version: 0.1.11  # fullseye lib version this note was generated for
---

# local_min_max_funct_1d — ONED `function` op

- **データ種**: `signal` → `table`
- **呼び出し**: `import fullseye as fs; fs.ledger.local_min_max_funct_1d(y)` (実装を直接呼ぶなら `import funct1d; funct1d.local_min_max_funct_1d(y)`、台帳から引くなら `ops1d.get("local_min_max_funct_1d")`)
...
[create_funct_1d_array](create_funct_1d_array.md) · [create_funct_1d_pairs](create_funct_1d_pairs.md) · [smooth_funct_1d_gauss](smooth_funct_1d_gauss.md) · [smooth_funct_1d_mean](smooth_funct_1d_mean.md) · [derivate_funct_1d](derivate_funct_1d.md) · [integrate_funct_1d](integrate_funct_1d.md) · [zero_crossings_funct_1d](zero_crossings_funct_1d.md) · [abs_funct_1d](abs_funct_1d.md)
