...
- **呼び出し**: `import fullseye as fs; fs.ledger.distance_funct_1d(y1, y2, mode='max') -> 'float'` (実装を直接呼ぶなら `import funct1d; funct1d.distance_funct_1d(y1, y2, mode='max') -> 'float'`、台帳から引くなら `ops1d.get("distance_funct_1d")`)
