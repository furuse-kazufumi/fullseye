...
# funct_1d_to_pairs — ONED `function` op

- **データ種**: `signal` → `pairs`
- **呼び出し**: `import fullseye as fs; fs.ledger.funct_1d_to_pairs(y)` (実装を直接呼ぶなら `import funct1d; funct1d.funct_1d_to_pairs(y)`、台帳から引くなら `ops1d.get("funct_1d_to_pairs")`)
