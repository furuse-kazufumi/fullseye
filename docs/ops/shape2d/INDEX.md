...
- [shape_description_2d](guides/shape_description_2d.md) — 2-D の形を記述して写す(EFD とランドマークワープ) — 使い方ガイド
...
[add_frame_corners](morph/add_frame_corners.md) · [blend](morph/blend.md) · [morph](morph/morph.md) · [morph_sequence](morph/morph_sequence.md) · [warp_piecewise_affine](morph/warp_piecewise_affine.md) · [warp_tps_image](morph/warp_tps_image.md)
