...
out: table
examples: [poc_barcode_1d, poc_battery_electrode_breathing, poc_calipers_under_illusion, poc_dimensional_inspection, poc_screw_thread_metrology, poc_solar_limb_darkening, poc_tree_ring_dendro, poc_water_level, poc_weld_bead_profile, poc_weld_radiograph_porosity]
