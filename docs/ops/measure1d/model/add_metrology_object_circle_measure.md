...
- **呼び出し**: `import metrology; metrology.add_metrology_object_circle_measure(model, row, col, radius, n: 'int' = 40) -> 'int'` (または `opsmeasure1d.get("add_metrology_object_circle_measure")`)
