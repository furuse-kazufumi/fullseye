...
- **呼び出し**: `import metrology; metrology.add_metrology_object_ellipse_measure(model, row, col, phi, ra, rb, n: 'int' = 40) -> 'int'` (または `opsmeasure1d.get("add_metrology_object_ellipse_measure")`)
