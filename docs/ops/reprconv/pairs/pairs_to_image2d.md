...
- **データ種**: `pairs` → `image2d`
- **呼び出し**: `import fullseye as fs; fs.ledger.pairs_to_image2d(pairs, shape=(64, 64))` (実装を直接呼ぶなら `import reprconv; reprconv.pairs_to_image2d(pairs, shape=(64, 64))`、台帳から引くなら `opsreprconv.get("pairs_to_image2d")`)
