...
- **呼び出し**: `import fullseye as fs; fs.ledger.keypoints_uv_to_points(keypoints, z=0.0)` (実装を直接呼ぶなら `import reprconv; reprconv.keypoints_uv_to_points(keypoints, z=0.0)`、台帳から引くなら `opsreprconv.get("keypoints_uv_to_points")`)
