...
**Measured coverage**: evolvable ops 930/930, typed ledger 1049/1061, one-line facade `fullseye.<name>` 568/1187 — **the facade is only half covered** (the rest are helpers, classes and re-exported modules).
