...
## PoC series — 113 real problems solved against a ground truth
...
**Measured substance**: of 1907 notes, **1888** link at least one runnable example (19 have none) and **1902** have a usage section of 120+ characters (5 are a one-line summary). The structure (call form, types, ops that chain next) is present in all 1907.
