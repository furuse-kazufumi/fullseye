...
## PoC series — 115 real problems solved against a ground truth
...
**Measured substance**: of 1915 notes, **1897** link at least one runnable example (18 have none) and **1910** have a usage section of 120+ characters (5 are a one-line summary). The structure (call form, types, ops that chain next) is present in all 1915.
