...
## PoC series — 124 real problems solved against a ground truth
...
**Measured coverage**: evolvable ops 932/932, typed ledger 1073/1085, one-line facade `fullseye.<name>` 568/1202 — **the facade is only half covered** (the rest are helpers, classes and re-exported modules).
