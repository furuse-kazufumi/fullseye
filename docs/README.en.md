...
## PoC series — 150 real problems solved against a ground truth
...
**Measured substance**: of 2188 notes, **2122** link at least one runnable example (66 have none) and **2137** have a usage section of 120+ characters (51 are a one-line summary). The structure (call form, types, ops that chain next) is present in all 2188.
