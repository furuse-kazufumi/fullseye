...
## PoC series — 84 real problems solved against a ground truth
...
**Measured coverage**: evolvable ops 901/901, typed ledger 966/1010, one-line facade `fullseye.<name>` 501/1091 — **the facade is only half covered** (the rest are helpers, classes and re-exported modules).
