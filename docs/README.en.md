...
**Measured coverage**: evolvable ops 932/932, typed ledger 1240/1252, one-line facade `fullseye.<name>` 596/1230 — **the facade is only half covered** (the rest are helpers, classes and re-exported modules).
