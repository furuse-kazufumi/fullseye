...
**Measured coverage**: evolvable ops 930/930, typed ledger 1033/1045, one-line facade `fullseye.<name>` 552/1148 — **the facade is only half covered** (the rest are helpers, classes and re-exported modules).
