...
## PoC series — 143 real problems solved against a ground truth
...
**2,183 per-operator notes** (call form, type contract, HALCON counterpart, references, provenance) and **57 family guides**. Entry points by dimension:
...
**Measured substance**: of 2188 notes, **2126** link at least one runnable example (62 have none) and **2135** have a usage section of 120+ characters (53 are a one-line summary). The structure (call form, types, ops that chain next) is present in all 2188.
