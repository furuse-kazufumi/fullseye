...
**실측 커버리지**: 진화 연산자 931/931, 타입 台帳 1050/1062, 한 줄 파사드 `fullseye.<이름>` 568/1202 — **파사드는 아직 절반**.

**내용 실측**: 2007건 중 실행 가능한 예제가 붙은 것은 **1966**건(41건은 없음), 사용법이 120자 이상인 것은 **1987**건(20건은 한 줄 요약). 구조(호출 형식·타입·다음 연산자)는 2007건 모두.
