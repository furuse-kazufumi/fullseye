...
**imgevolve maps to 407 / 2313 HALCON operators (17.6%)** via `Op.halcon`, from 733 registry ops.
...
- **398** claimed names exist in **all** scraped releases (stable).
