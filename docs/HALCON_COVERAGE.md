...
- **Matching** (18/96): adapt_shape_model_high_noise, apply_deep_counting_model, clear_deformable_model, clear_descriptor_model, clear_ncc_model, clear_shape_model, create_calib_descriptor_model, create_deep_counting_model, create_local_deformable_model, create_local_deformable_model_xld, create_planar_calib_deformable_model, create_planar_calib_deformable_model_xld
