...
**imgevolve maps to 464 / 2313 HALCON operators (20.1%)** via `Op.halcon`, from 733 registry ops.
...
- **Transformations** (47/118): angle_ll, angle_lx, axis_angle_to_quat, convert_point_3d_cart_to_spher, convert_point_3d_spher_to_cart, convert_pose_type, create_generic_shape_model, create_pose, deserialize_dual_quat, deserialize_hom_mat2d, deserialize_hom_mat3d, deserialize_pose
...
- **454** claimed names exist in **all** scraped releases (stable).
