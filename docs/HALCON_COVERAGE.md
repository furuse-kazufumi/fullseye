...
**imgevolve maps to 344 / 2313 HALCON operators (14.9%)** via `Op.halcon`, from 691 registry ops.
...
- **Image** (25/110): add_channels, append_channel, area_center_gray, change_domain, channels_to_image, close_framegrabber, complex_to_real, compose2, compose3, compose4, compose5, compose6
...
- **335** claimed names exist in **all** scraped releases (stable).
