...
**imgevolve maps to 418 / 2313 HALCON operators (18.1%)** via `Op.halcon`, from 733 registry ops.
...
- **409** claimed names exist in **all** scraped releases (stable).
