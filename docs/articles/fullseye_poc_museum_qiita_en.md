...
- 2026-09-22 — Seeing the Complex Plane as an Area — When the Picture Proves the Theorem (poc_complex_plane_fields)
...
## 48. Trabecular Thickness, Separation and Bone Volume Fraction — The Plate Model and the Direct Method Disagree on the Same Image
...
## 49. Counting Overlapping Cells — Count, Over-Segmentation and Under-Segmentation as Three Numbers
...
## 50. Colocalization lies under bleed-through — Pearson and Manders break in different places
...
## 51. MRI Bias Field and Tissue Area — Grey and White Matter Fail in Opposite Directions, and the Sum Hides It
...
## 52. Ploidy From Integrated Nuclear Intensity — Area Cannot Separate It
...
## 53. Extracting a Vessel Network — Spurs, Overestimated Radii Near Branches, and a Fragile Exponent
...
## 54. Wound Area Over Time — Calibration Error Enters the Area Squared
...
## 55. A Larval Connectome as a Reservoir Reads Digits — and the Wiring Is Not What Does It
...
## 56. Watching a Pulse Travel the Wiring on the 3-D Fly Brain — Connectome vs Degree-Preserving Shuffle
...
## 57. What the Compound Eye Sees, and Where the Brain Answers — Trace an Ommatidium and the Response Travels the Wiring
...
## 58. A Second Opinion for EM Connectome Proofreading — Membranes Belong Only on Label Boundaries
...
## 59. Motor Quantisation — Where the Command Dimension Collapses Between Brain and Muscle (the Fly's Neck and an RL Policy's Joints on One Scale)
...
## 60. The MICrONS Brain Wave — How Much of the Measured Response Does the Wiring Explain in 1 mm^3 of Visual Cortex
...
## 61. Branch Territories — Handing Every Voxel Its Nearest Branch, Not Just Its Distance, Makes Per-Branch Volume and Radius Countable
...
## 62. All-Sky Cloud Cover — Counting Pixels Is Biased by Position
...
## 63. How Many Frames for What Photometric Precision?
...
## 64. Change detection under misregistration — false positives are edge bands, with a cliff
...
## 66. Measuring Terrain — Slope, Flow and Insolation Against Closed Forms
...
## 67. Exoplanet transit from aperture photometry — depth and duration fail separately
...
## 68. Coordinates Go Wrong by Tens of Metres While Still Looking Plausible
...
## 69. Leaf disease severity — colour axes survive the lighting; the grade is decided by the leaf mask and the edge convention
...
## 70. Drone Thermography of a PV Plant — You Think You Are Measuring Temperature Difference, but You Are Measuring Wind and Viewing Angle
...
## 71. Planting Known Stars in a Real Deep Field — Contamination Lies About the Measurement and the Confidence in the Same Direction
...
## 72. River surface velocity from an oblique video (LSPIV) — velocity error and discharge error are different numbers
...
## 73. Sea-Ice Concentration — The Answer Depends on How Mixed Pixels Are Counted
...
## 74. Sweep Width — One Number Measured from Aerial Images Decides Whether the Search Works
...
## 75. Where Is the Edge of a Limb-Darkened Disc? The 50 % Rule Reads the Radius Small
...
## 76. To What Fraction of a Pixel Can a Star Be Located, and Where Is the Cliff?
...
## 77. Counting tree rings and extracting the width series — ring count and width correlation fail separately
...
## 78. Counting Crop Green — Ground Truth as Per-Pixel Leaf Area Fraction
...
## 79. River Stage From an Oblique Photo — Ignoring Perspective Bends the Row-Number Error Into an Arc
...
## 80. There Are Two Kinds of Height, for Real — Putting a Height-Frame Mix-Up Under a Detector with 523 Published Survey Marks
...
## 81. How Much Camera Shake Can Be Undone — Make the Kernel, Apply It, Invert It, Compare
...
## 82. Pseudo-colour changes what the reader decides — counting edges that are not there
...
## 83. The Fly's Compound Eye Is a Light-Field Sensor — Neural Superposition Pays Only Up to the Knee
...
## 84. Where CT Reconstruction Starts to Break as Projections Are Removed
...
## 85. Removing Haze — Ground Truth From the Scattering Model, Transmission and Airlight Scored Apart
...
## 86. Ranging by Counting Photons — How Many for How Many Millimetres?
...
## 87. The Fly's Visual Front End as a Chain of Operators — Turning and Walking Through a Synthetic Sky, What Can and Cannot Be Read
...
## 88. Focus Stacking — The All-in-Focus Image and the Depth Map Are Different Things
...
## 89. Depth From a Light Field — A Light Field of Known Depth, Confronted With Its Nulls
...
## 90. Deblurring a Real Photograph — Three Rulers, Three Different Winners
...
## 91. Does Super-Resolution Add Information? Downsample With the Truth in Hand, Restore, Count
...
## 92. Holding a Course with a Fly's Optic Lobe Alone — From the Lamina to the Steering, Without Learning
...
## 93. A Photograph as One Line, Drawn by Rotating Circles — Tone, Stipple, Tour, Fourier Series, G-code
...
## 94. Seeing the Complex Plane as an Area — When the Picture Proves the Theorem
...
## 95. Theorems as Gates — Apollonian Gaskets, Ford Circles, Geodesic Domes, Phyllotaxis, IFS, Space-Filling Curves
...
## 96. One Beat — A Two-Slit Fringe and a Print Moire Are the Same Mathematics
...
## 97. What a Picture Cannot Check — Scoring Dynamical Systems and Minimal Surfaces by Identity and Definition
...
## 98. Modal identification from video — frequency survives to the end, damping lies first
...
## 99. The Cold-Chain Temperature Record — Where You Taped the Logger Is the Verdict
...
## 100. Measuring the Growth, Not the Width — Rephotographing the Same Wall Changes What the Error Is
...
## 101. Micro-Vibration of a Structure From Video — Does Motion Magnification Help You Measure?
...
## 102. Particle Tracking as a (row, column, time) Volume — Mislinks Come in Two Directions
...
## 103. Did It Settle, or Did We Just Scan It Again — What Changes When You Cut at the Detection Limit
...
## 104. Template Tracking Drifts Quietly Before It Ever Loses the Target
...
## 105. A Growth Time-Lapse as Space-Time Connected Components
...
## 106. Counting in (x, y, t) — Vehicles Passed, Occlusion, and One Constant: L/V
...
## 107. Where the Warehouse Dwell Came From — Count Waiting Without Its Kind and Everything Is Just Congestion
...
## 108. The Arrival-Time Surface as an Isosurface in (x, y, t)
...
## 109. A Clip as a Space-Time Cube — What Passed Where, and When, in One Solid
...
## 110. Living Tissue in 3D+t Without a Generator — Magnify, Flow, Interpolate, Height, All Against Truth
...
## 111. A Reprojection Error of 0.05 px Guarantees Nothing
...
## 112. Chain the Neighbours Together and You Cannot Get Back Where You Started
...
## 113. Measuring on a Real Stereo Photograph — Three Stumbles Synthesis Never Produces
...
## 114. The Convergence Basin of Point-Cloud Registration — How Far Off Can the Initial Pose Be?
...
## 115. Which Quantities Really Survive a Rotation — Auditing Invariance on a Real Coin
...
## 116. Where Is the Public Camera Looking — The Orientation of a Fixed Camera Whose Only Published Fact Is Its Position, from the Picture Itself
...
## 117. Where Is the Public Camera Looking, for Real — Hunting the Sun in 807 Road Cameras, Fixing the Heading from One Sunset and Checking It Against the Road
...
## 118. Peeling Layers With Many Wavelengths — Underdrawing, Ground, Glaze and Fading, Truth in Hand
...
## 119. Stripping Specular Reflection With Polarisation — Truth From the Fresnel Equations
...
## 120. Separating a Real Immunostain by Colour — The Watchdog Was Blind to Exactly the Error It Should Catch
...
## 121. Colour Constancy (White Balance) — No Method Works, Only Conditions Do
...
## 122. Straightening a Hand-Held Document Photo — Keystone Correction and Shadow Removal Against Ground Truth
...
## 123. Forgery Detection as an ROC — Not the One Image Found, but Detection at a Fixed False-Positive Rate
...
## 124. Craquelure networks — of three indicators, only junction degree breaks under imaging conditions
...
## 125. Camera Fingerprints (PRNU): Which Camera Took This? — The Fingerprint Grows With Frame Count and Dies at the Save Button
...
## 126. Battery cell degradation by CT — the swelling shows outside, the cause stays inside
...
## 127. Fusing two sensors into a bird's-eye grid — a calibration that passes in pixels turns into metres at range
...
## 128. CAD-to-scan deviation inspection — the fit absorbs the defect and invents a dent
...
## 129. Crop leaf area from above — folded by projection before it is ever hidden
...
## 130. Collapsing joint voids into one number — what the number drops is the shape that matters
...
## 131. Manufacturability from geometry alone — faces that sit on the threshold flip when you smooth them
...
## 132. Earthwork on a slope — align first and the scar gets shallower
...
## 133. Weighing an Animal from Silhouettes — The Error You Can Buy Down, and the One You Cannot
...
## 134. Repair the mesh, then measure — the defect count clears, the quantity does not
...
## 135. Pallet load utilization — one number gives voids and overhang the same value
...
## 136. Pipe Wall Loss on the Unwrapped Map — The Axis You Choose Eats the Invert Corrosion
...
## 137. Warpage lives in the layer history — averaging the area throws the placement away
...
## 138. Human-machine clearance — swap the body for a point, and the hazard vanishes with it
...
## 139. As-built deviation of a room — the compromise pose is handed to the innocent element
...
## 140. Re-surveying a structure year by year — when the vantage moves, decay appears to advance
...
## 141. Restoring what is missing by symmetry — the plane you assume is the lie you get
