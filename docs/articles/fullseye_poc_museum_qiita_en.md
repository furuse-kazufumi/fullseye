...
- 2026-09-21 — A Second Opinion for EM Connectome Proofreading — Membranes Belong Only on Label Boundaries (poc_em_second_opinion)
- 2026-09-21 — A Clip as a Space-Time Cube — What Passed Where, and When, in One Solid (poc_video_cube)
- 2026-09-21 — Living Tissue in 3D+t Without a Generator — Magnify, Flow, Interpolate, Height, All Against Truth (poc_live4d)
- 2026-09-21 — Motor Quantisation — Where the Command Dimension Collapses Between Brain and Muscle (the Fly's Neck and an RL Policy's Joints on One Scale) (poc_connectome_motor_bottleneck)
- 2026-09-20 — A Larval Connectome as a Reservoir Reads Digits — and the Wiring Is Not What Does It (poc_larval_connectome_reservoir)
- 2026-09-20 — Watching a Pulse Travel the Wiring on the 3-D Fly Brain — Connectome vs Degree-Preserving Shuffle (poc_malecns_activity_wave)
- 2026-09-20 — What the Compound Eye Sees, and Where the Brain Answers — Trace an Ommatidium and the Response Travels the Wiring (poc_eye_to_brain)
- 2026-09-17 — Finding and Fixing Wrong Characters Without Recognising Them — the Threshold Comes from Typeface Spread (poc_glyph_typo_detection)

## The wings (129 exhibits)
...
## 27. Matching Full 2-D Inspection to Sampled 3-D Inspection — A Grid Overlaps Itself
...
## 28. As-built wall deviation — the bounding box measures the room's heading, not its size
...
## 29. Measuring electrode breathing in microns — sub-pixel is not enough
...
## 30. Measuring Bilateral Asymmetry — The Symmetry Plane Gets Dragged by the Deformation
...
## 31. Strain From Speckle Images (DIC)
...
## 32. Die tilt and TSV overlay from one CT — tilt fakes rotation too
...
## 33. Dimensional Inspection of a Machined Part — Bias and Scatter as Two Numbers
...
## 34. Fibre Orientation Distribution — Angles Repeat Every 180 Degrees, and a Naive Mean Is 90 Degrees Off
...
## 35. Gear Tooth Metrology — Eccentricity Is Order 1, Teeth Are Order z
...
## 36. How Accurately a White-Light Interferometer Measures a Nanometre Step
...
## 37. Metallographic Grain Size — The Planimetric and Intercept Methods Fall Off Different Cliffs
...
## 38. Why the Seafloor Smiles — A Wrong Sound-Speed Profile Breaks Only the Outer Beams
...
## 39. Particle Size Distribution From Images — Merging and Edge Cuts Pull Opposite Ways and Cancel
...
## 40. Stress by Photoelasticity — Unwrapping Fails First at the Isotropic Point
...
## 41. Measuring Rail with a Chord — At the Wavelengths Where the Transfer Function Is Zero, Any Amplitude Reads Zero
...
## 42. Counting and Measuring Real Coins — A Correct Answer Is Not a Safe One
...
## 43. Pitch, Flank Angle and Pitch Diameter From a Thread Silhouette — Tilt Shows Up With Opposite Signs on the Two Flanks
...
## 44. Stockpile Inventory — The Answer Is Fixed by the Ground Nobody Measured
...
## 45. Strain History in a Creep Test — Cumulative or Direct?
...
## 46. How Far Sa / Sq / Sz Survive Sampling and Cutoff
...
## 47. Trabecular Thickness, Separation and Bone Volume Fraction — The Plate Model and the Direct Method Disagree on the Same Image
...
## 48. Counting Overlapping Cells — Count, Over-Segmentation and Under-Segmentation as Three Numbers
...
## 51. Ploidy From Integrated Nuclear Intensity — Area Cannot Separate It
...
## 52. Extracting a Vessel Network — Spurs, Overestimated Radii Near Branches, and a Fragile Exponent
...
## 53. Wound Area Over Time — Calibration Error Enters the Area Squared
...
## 55. Watching a Pulse Travel the Wiring on the 3-D Fly Brain — Connectome vs Degree-Preserving Shuffle
...
## 56. What the Compound Eye Sees, and Where the Brain Answers — Trace an Ommatidium and the Response Travels the Wiring
...
## 57. A Second Opinion for EM Connectome Proofreading — Membranes Belong Only on Label Boundaries
...
## 58. Motor Quantisation — Where the Command Dimension Collapses Between Brain and Muscle (the Fly's Neck and an RL Policy's Joints on One Scale)
...
## 59. All-Sky Cloud Cover — Counting Pixels Is Biased by Position
...
## 60. How Many Frames for What Photometric Precision?
...
## 61. Change detection under misregistration — false positives are edge bands, with a cliff
...
## 62. A 3-D Thermal Field from Sparse Sensors — The Grid's Blind Spot Erases a Rack
...
## 63. Measuring Terrain — Slope, Flow and Insolation Against Closed Forms
...
## 64. Exoplanet transit from aperture photometry — depth and duration fail separately
...
## 65. Coordinates Go Wrong by Tens of Metres While Still Looking Plausible
...
## 66. Leaf disease severity — colour axes survive the lighting; the grade is decided by the leaf mask and the edge convention
...
## 67. Drone Thermography of a PV Plant — You Think You Are Measuring Temperature Difference, but You Are Measuring Wind and Viewing Angle
...
## 68. Planting Known Stars in a Real Deep Field — Contamination Lies About the Measurement and the Confidence in the Same Direction
...
## 69. River surface velocity from an oblique video (LSPIV) — velocity error and discharge error are different numbers
...
## 70. Sea-Ice Concentration — The Answer Depends on How Mixed Pixels Are Counted
...
## 71. Sweep Width — One Number Measured from Aerial Images Decides Whether the Search Works
...
## 72. Where Is the Edge of a Limb-Darkened Disc? The 50 % Rule Reads the Radius Small
...
## 73. To What Fraction of a Pixel Can a Star Be Located, and Where Is the Cliff?
...
## 74. Counting tree rings and extracting the width series — ring count and width correlation fail separately
...
## 75. Counting Crop Green — Ground Truth as Per-Pixel Leaf Area Fraction
...
## 76. River Stage From an Oblique Photo — Ignoring Perspective Bends the Row-Number Error Into an Arc
...
## 77. How Much Camera Shake Can Be Undone — Make the Kernel, Apply It, Invert It, Compare
...
## 78. Pseudo-colour changes what the reader decides — counting edges that are not there
...
## 79. The Fly's Compound Eye Is a Light-Field Sensor — Neural Superposition Pays Only Up to the Knee
...
## 80. Where CT Reconstruction Starts to Break as Projections Are Removed
...
## 81. Removing Haze — Ground Truth From the Scattering Model, Transmission and Airlight Scored Apart
...
## 82. Ranging by Counting Photons — How Many for How Many Millimetres?
...
## 83. The Fly's Visual Front End as a Chain of Operators — Turning and Walking Through a Synthetic Sky, What Can and Cannot Be Read
...
## 84. Focus Stacking — The All-in-Focus Image and the Depth Map Are Different Things
...
## 85. Depth From a Light Field — A Light Field of Known Depth, Confronted With Its Nulls
...
## 86. Deblurring a Real Photograph — Three Rulers, Three Different Winners
...
## 87. Does Super-Resolution Add Information? Downsample With the Truth in Hand, Restore, Count
...
## 88. Modal identification from video — frequency survives to the end, damping lies first
...
## 91. Micro-Vibration of a Structure From Video — Does Motion Magnification Help You Measure?
...
## 92. Particle Tracking as a (row, column, time) Volume — Mislinks Come in Two Directions
...
## 93. Did It Settle, or Did We Just Scan It Again — What Changes When You Cut at the Detection Limit
...
## 94. Template Tracking Drifts Quietly Before It Ever Loses the Target
...
## 95. A Growth Time-Lapse as Space-Time Connected Components
...
## 96. Counting in (x, y, t) — Vehicles Passed, Occlusion, and One Constant: L/V
...
## 97. Where the Warehouse Dwell Came From — Count Waiting Without Its Kind and Everything Is Just Congestion
...
## 98. The Arrival-Time Surface as an Isosurface in (x, y, t)
...
## 99. A Clip as a Space-Time Cube — What Passed Where, and When, in One Solid
...
## 100. Living Tissue in 3D+t Without a Generator — Magnify, Flow, Interpolate, Height, All Against Truth
...
## 101. A Reprojection Error of 0.05 px Guarantees Nothing
...
## 102. Chain the Neighbours Together and You Cannot Get Back Where You Started
...
## 103. Measuring on a Real Stereo Photograph — Three Stumbles Synthesis Never Produces
...
## 104. The Convergence Basin of Point-Cloud Registration — How Far Off Can the Initial Pose Be?
...
## 105. Which Quantities Really Survive a Rotation — Auditing Invariance on a Real Coin
...
## 106. Peeling Layers With Many Wavelengths — Underdrawing, Ground, Glaze and Fading, Truth in Hand
...
## 107. Stripping Specular Reflection With Polarisation — Truth From the Fresnel Equations
...
## 108. Separating a Real Immunostain by Colour — The Watchdog Was Blind to Exactly the Error It Should Catch
...
## 109. Colour Constancy (White Balance) — No Method Works, Only Conditions Do
...
## 110. Straightening a Hand-Held Document Photo — Keystone Correction and Shadow Removal Against Ground Truth
...
## 111. Forgery Detection as an ROC — Not the One Image Found, but Detection at a Fixed False-Positive Rate
...
## 112. Craquelure networks — of three indicators, only junction degree breaks under imaging conditions
...
## 113. Camera Fingerprints (PRNU): Which Camera Took This? — The Fingerprint Grows With Frame Count and Dies at the Save Button
...
## 114. Battery cell degradation by CT — the swelling shows outside, the cause stays inside
...
## 115. Fusing two sensors into a bird's-eye grid — a calibration that passes in pixels turns into metres at range
...
## 116. CAD-to-scan deviation inspection — the fit absorbs the defect and invents a dent
...
## 118. Collapsing joint voids into one number — what the number drops is the shape that matters
...
## 119. Manufacturability from geometry alone — faces that sit on the threshold flip when you smooth them
...
## 120. Earthwork on a slope — align first and the scar gets shallower
...
## 121. Weighing an Animal from Silhouettes — The Error You Can Buy Down, and the One You Cannot
...
## 122. Repair the mesh, then measure — the defect count clears, the quantity does not
...
## 123. Pallet load utilization — one number gives voids and overhang the same value
...
## 124. Pipe Wall Loss on the Unwrapped Map — The Axis You Choose Eats the Invert Corrosion
...
## 125. Warpage lives in the layer history — averaging the area throws the placement away
...
## 126. Human-machine clearance — swap the body for a point, and the hazard vanishes with it
...
## 127. As-built deviation of a room — the compromise pose is handed to the innocent element
...
## 128. Re-surveying a structure year by year — when the vantage moves, decay appears to advance
...
## 129. Restoring what is missing by symmetry — the plane you assume is the lie you get
