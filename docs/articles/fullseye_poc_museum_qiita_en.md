...
- 2026-09-21 — Print Layer Inspection — Closing the Shape → Layer → Path → Image Loop and Catching Planted Defects by the Numbers (poc_print_layer_inspection)

## The wings (137 exhibits)
...
## 94. Modal identification from video — frequency survives to the end, damping lies first
...
## 95. The Cold-Chain Temperature Record — Where You Taped the Logger Is the Verdict
...
## 96. Measuring the Growth, Not the Width — Rephotographing the Same Wall Changes What the Error Is
...
## 97. Micro-Vibration of a Structure From Video — Does Motion Magnification Help You Measure?
...
## 98. Particle Tracking as a (row, column, time) Volume — Mislinks Come in Two Directions
...
## 99. Did It Settle, or Did We Just Scan It Again — What Changes When You Cut at the Detection Limit
...
## 100. Template Tracking Drifts Quietly Before It Ever Loses the Target
...
## 101. A Growth Time-Lapse as Space-Time Connected Components
...
## 102. Counting in (x, y, t) — Vehicles Passed, Occlusion, and One Constant: L/V
...
## 103. Where the Warehouse Dwell Came From — Count Waiting Without Its Kind and Everything Is Just Congestion
...
## 104. The Arrival-Time Surface as an Isosurface in (x, y, t)
...
## 105. A Clip as a Space-Time Cube — What Passed Where, and When, in One Solid
...
## 106. Living Tissue in 3D+t Without a Generator — Magnify, Flow, Interpolate, Height, All Against Truth
...
## 107. A Reprojection Error of 0.05 px Guarantees Nothing
...
## 108. Chain the Neighbours Together and You Cannot Get Back Where You Started
...
## 109. Measuring on a Real Stereo Photograph — Three Stumbles Synthesis Never Produces
...
## 110. The Convergence Basin of Point-Cloud Registration — How Far Off Can the Initial Pose Be?
...
## 111. Which Quantities Really Survive a Rotation — Auditing Invariance on a Real Coin
...
## 112. Where Is the Public Camera Looking — The Orientation of a Fixed Camera Whose Only Published Fact Is Its Position, from the Picture Itself
...
## 113. Where Is the Public Camera Looking, for Real — Hunting the Sun in 807 Road Cameras, Fixing the Heading from One Sunset and Checking It Against the Road
...
## 114. Peeling Layers With Many Wavelengths — Underdrawing, Ground, Glaze and Fading, Truth in Hand
...
## 115. Stripping Specular Reflection With Polarisation — Truth From the Fresnel Equations
...
## 116. Separating a Real Immunostain by Colour — The Watchdog Was Blind to Exactly the Error It Should Catch
...
## 117. Colour Constancy (White Balance) — No Method Works, Only Conditions Do
...
## 118. Straightening a Hand-Held Document Photo — Keystone Correction and Shadow Removal Against Ground Truth
...
## 119. Forgery Detection as an ROC — Not the One Image Found, but Detection at a Fixed False-Positive Rate
...
## 120. Craquelure networks — of three indicators, only junction degree breaks under imaging conditions
...
## 121. Camera Fingerprints (PRNU): Which Camera Took This? — The Fingerprint Grows With Frame Count and Dies at the Save Button
...
## 122. Battery cell degradation by CT — the swelling shows outside, the cause stays inside
...
## 123. Fusing two sensors into a bird's-eye grid — a calibration that passes in pixels turns into metres at range
...
## 124. CAD-to-scan deviation inspection — the fit absorbs the defect and invents a dent
...
## 125. Crop leaf area from above — folded by projection before it is ever hidden
...
## 126. Collapsing joint voids into one number — what the number drops is the shape that matters
...
## 127. Manufacturability from geometry alone — faces that sit on the threshold flip when you smooth them
...
## 128. Earthwork on a slope — align first and the scar gets shallower
...
## 129. Weighing an Animal from Silhouettes — The Error You Can Buy Down, and the One You Cannot
...
## 130. Repair the mesh, then measure — the defect count clears, the quantity does not
...
## 131. Pallet load utilization — one number gives voids and overhang the same value
...
## 132. Pipe Wall Loss on the Unwrapped Map — The Axis You Choose Eats the Invert Corrosion
...
## 133. Warpage lives in the layer history — averaging the area throws the placement away
...
## 134. Human-machine clearance — swap the body for a point, and the hazard vanishes with it
...
## 135. As-built deviation of a room — the compromise pose is handed to the innocent element
...
## 136. Re-surveying a structure year by year — when the vantage moves, decay appears to advance
...
## 137. Restoring what is missing by symmetry — the plane you assume is the lie you get
