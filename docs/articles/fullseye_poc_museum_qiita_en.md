...
- 2026-09-23 — What a Picture Cannot Check — Scoring Dynamical Systems and Minimal Surfaces by Identity and Definition (poc_what_a_picture_cannot_check)
- 2026-09-23 — How Much of That Number Is Your Measuring - Gauge R&R and Measurement Uncertainty (poc_measurement_system_analysis)
- 2026-09-23 — Pictures That Carry Their Own Truth - Illusions, Endless Drawing, Seamless Loops (poc_illusions_and_perpetual_drawing)
- 2026-09-22 — Holding a Course with a Fly's Optic Lobe Alone — From the Lamina to the Steering, Without Learning (poc_fly_optomotor_steering)
- 2026-09-22 — There Are Two Kinds of Height, for Real — Putting a Height-Frame Mix-Up Under a Detector with 523 Published Survey Marks (poc_geodetic_benchmarks_real)
- 2026-09-22 — A Photograph as One Line, Drawn by Rotating Circles — Tone, Stipple, Tour, Fourier Series, G-code (poc_one_stroke_epicycles)

## The wings (143 exhibits)
...
## 49. Trabecular Thickness, Separation and Bone Volume Fraction — The Plate Model and the Direct Method Disagree on the Same Image
...
## 50. Counting Overlapping Cells — Count, Over-Segmentation and Under-Segmentation as Three Numbers
...
## 51. Colocalization lies under bleed-through — Pearson and Manders break in different places
...
## 52. MRI Bias Field and Tissue Area — Grey and White Matter Fail in Opposite Directions, and the Sum Hides It
...
## 53. Ploidy From Integrated Nuclear Intensity — Area Cannot Separate It
...
## 54. Extracting a Vessel Network — Spurs, Overestimated Radii Near Branches, and a Fragile Exponent
...
## 55. Wound Area Over Time — Calibration Error Enters the Area Squared
...
## 56. A Larval Connectome as a Reservoir Reads Digits — and the Wiring Is Not What Does It
...
## 57. Watching a Pulse Travel the Wiring on the 3-D Fly Brain — Connectome vs Degree-Preserving Shuffle
...
## 58. What the Compound Eye Sees, and Where the Brain Answers — Trace an Ommatidium and the Response Travels the Wiring
...
## 59. A Second Opinion for EM Connectome Proofreading — Membranes Belong Only on Label Boundaries
...
## 60. Motor Quantisation — Where the Command Dimension Collapses Between Brain and Muscle (the Fly's Neck and an RL Policy's Joints on One Scale)
...
## 61. The MICrONS Brain Wave — How Much of the Measured Response Does the Wiring Explain in 1 mm^3 of Visual Cortex
...
## 62. Branch Territories — Handing Every Voxel Its Nearest Branch, Not Just Its Distance, Makes Per-Branch Volume and Radius Countable
...
## 63. All-Sky Cloud Cover — Counting Pixels Is Biased by Position
...
## 64. How Many Frames for What Photometric Precision?
...
## 65. Change detection under misregistration — false positives are edge bands, with a cliff
...
## 66. A 3-D Thermal Field from Sparse Sensors — The Grid's Blind Spot Erases a Rack
...
## 67. Measuring Terrain — Slope, Flow and Insolation Against Closed Forms
...
## 68. Exoplanet transit from aperture photometry — depth and duration fail separately
...
## 70. Leaf disease severity — colour axes survive the lighting; the grade is decided by the leaf mask and the edge convention
...
## 71. Drone Thermography of a PV Plant — You Think You Are Measuring Temperature Difference, but You Are Measuring Wind and Viewing Angle
...
## 72. Planting Known Stars in a Real Deep Field — Contamination Lies About the Measurement and the Confidence in the Same Direction
...
## 73. River surface velocity from an oblique video (LSPIV) — velocity error and discharge error are different numbers
...
## 74. Sea-Ice Concentration — The Answer Depends on How Mixed Pixels Are Counted
...
## 75. Sweep Width — One Number Measured from Aerial Images Decides Whether the Search Works
...
## 76. Where Is the Edge of a Limb-Darkened Disc? The 50 % Rule Reads the Radius Small
...
## 77. To What Fraction of a Pixel Can a Star Be Located, and Where Is the Cliff?
...
## 78. Counting tree rings and extracting the width series — ring count and width correlation fail separately
...
## 79. Counting Crop Green — Ground Truth as Per-Pixel Leaf Area Fraction
...
## 80. River Stage From an Oblique Photo — Ignoring Perspective Bends the Row-Number Error Into an Arc
...
## 81. There Are Two Kinds of Height, for Real — Putting a Height-Frame Mix-Up Under a Detector with 523 Published Survey Marks
...
## 82. How Much Camera Shake Can Be Undone — Make the Kernel, Apply It, Invert It, Compare
...
## 83. Pseudo-colour changes what the reader decides — counting edges that are not there
...
## 84. The Fly's Compound Eye Is a Light-Field Sensor — Neural Superposition Pays Only Up to the Knee
...
## 85. Where CT Reconstruction Starts to Break as Projections Are Removed
...
## 86. Removing Haze — Ground Truth From the Scattering Model, Transmission and Airlight Scored Apart
...
## 87. Ranging by Counting Photons — How Many for How Many Millimetres?
...
## 88. The Fly's Visual Front End as a Chain of Operators — Turning and Walking Through a Synthetic Sky, What Can and Cannot Be Read
...
## 89. Focus Stacking — The All-in-Focus Image and the Depth Map Are Different Things
...
## 90. Depth From a Light Field — A Light Field of Known Depth, Confronted With Its Nulls
...
## 91. Deblurring a Real Photograph — Three Rulers, Three Different Winners
...
## 92. Does Super-Resolution Add Information? Downsample With the Truth in Hand, Restore, Count
...
## 93. Holding a Course with a Fly's Optic Lobe Alone — From the Lamina to the Steering, Without Learning
...
## 94. A Photograph as One Line, Drawn by Rotating Circles — Tone, Stipple, Tour, Fourier Series, G-code
...
## 95. Seeing the Complex Plane as an Area — When the Picture Proves the Theorem
...
## 96. Theorems as Gates — Apollonian Gaskets, Ford Circles, Geodesic Domes, Phyllotaxis, IFS, Space-Filling Curves
...
## 97. One Beat — A Two-Slit Fringe and a Print Moire Are the Same Mathematics
...
## 98. What a Picture Cannot Check — Scoring Dynamical Systems and Minimal Surfaces by Identity and Definition
...
## 99. Pictures That Carry Their Own Truth - Illusions, Endless Drawing, Seamless Loops
...
*↑ **Pictures That Carry Their Own Truth - Illusions, Endless Drawing, Seamless Loops** ―― Most Fullseye operators measure a picture that was handed to them; this family alone works the other way and generates pictures that ship with their own ground truth. Optical illusions are the purest case of "looking does not verify": the cafe-wall mortar lines are exactly horizontal (all eight at slope 0.0e+00), the two Mueller-Lyer shafts are pixel-identical once the arrowheads are removed, the two checker-shadow squares hold the same floating-point value, and along the Kanizsa contour the image is exactly the background (ptp 0.0e+00). And the illusions do not only fool people - measured naively on the arrowed figure, the two shafts come out as 223 and 225 pixels, where the truth is 220 for both. Endless systems cannot be scored by appearance, since any stopping point is mid-way, so only systems carrying an identity independent of the picture were admitted: rule 90's nth row is C(n,k) mod 2 by Lucas' theorem, Langton's ant repeats the same diagonal (2,2) step every 104 and its highway adds exactly 12 cells per period, the Apollonian packing satisfies Descartes' circle theorem to 1.2e-16, the flow field is divergence-free to 7.0e-17, reaction-diffusion conserves mass to 2.0e-16, and diamond-square never overwrites its corners. For the loops the seam is not removed but never created: with every time-dependent quantity a function of theta, t = T is the same expression as t = 0, and the seam ratio lands at 0.997-1.041 across four systems - where 1, not 0, is the correct answer, since 0 would mean nothing is moving. Four defects surfaced while building it, none of them visible in the picture: an int64 overflow at C(62,31)x31, the wrong pair of checker squares (0.31 apart), a growth rate guessed as 52 cells per 104 steps that measurement contradicted, and a square-root branch in the Apollonian solver that sent a chain of circles outside the bounding disc - which still looked convincingly fractal until the image was opened and read.*

[![カフェウォール錯視(ずらし量 0.25)。**目地は厳密な水平線**で、8 本すべて傾き 0.0e+00(実測)。傾いて見えるのは、明暗の市松が目地の位置を引っぱるため。ずらし量が 0 か 0.5 では錯視が消えます —— 次の図。](https://raw.githubusercontent.com/furuse-kazufumi/fullseye/master/docs/articles/assets/poc/poc_illusions_and_perpetual_drawing/02_cafe_wall_720.jpg)](https://raw.githubusercontent.com/furuse-kazufumi/fullseye/master/docs/articles/assets/poc/poc_illusions_and_perpetual_drawing/02_cafe_wall.png)

*↑ The measurement ―― カフェウォール錯視(ずらし量 0.25)。**目地は厳密な水平線**で、8 本すべて傾き 0.0e+00(実測)。傾いて見えるのは、明暗の市松が目地の位置を引っぱるため。ずらし量が 0 か 0.5 では錯視が消えます —— 次の図。 (figure labels are in Japanese; the numbers are the same)*

[![**継ぎ目の無い循環動画**。最後のコマから最初のコマへ戻るところに、切れ目がありません。作り方が要点で、「最後に頭へ戻す」のではなく、**時間依存の量をすべてθ の関数にして θ を 0→2π 回す**と、t=T は t=0 と同じ式にな](https://raw.githubusercontent.com/furuse-kazufumi/fullseye/master/docs/articles/assets/poc/poc_illusions_and_perpetual_drawing/23_loop.gif)](https://raw.githubusercontent.com/furuse-kazufumi/fullseye/master/docs/articles/assets/poc/poc_illusions_and_perpetual_drawing/23_loop.gif)
...
## 100. Modal identification from video — frequency survives to the end, damping lies first
...
## 101. The Cold-Chain Temperature Record — Where You Taped the Logger Is the Verdict
...
## 102. Measuring the Growth, Not the Width — Rephotographing the Same Wall Changes What the Error Is
...
## 103. Micro-Vibration of a Structure From Video — Does Motion Magnification Help You Measure?
...
## 104. Particle Tracking as a (row, column, time) Volume — Mislinks Come in Two Directions
...
## 105. Did It Settle, or Did We Just Scan It Again — What Changes When You Cut at the Detection Limit
...
## 106. Template Tracking Drifts Quietly Before It Ever Loses the Target
...
## 107. A Growth Time-Lapse as Space-Time Connected Components
...
## 108. Counting in (x, y, t) — Vehicles Passed, Occlusion, and One Constant: L/V
...
## 109. Where the Warehouse Dwell Came From — Count Waiting Without Its Kind and Everything Is Just Congestion
...
## 110. The Arrival-Time Surface as an Isosurface in (x, y, t)
...
## 111. A Clip as a Space-Time Cube — What Passed Where, and When, in One Solid
...
## 112. Living Tissue in 3D+t Without a Generator — Magnify, Flow, Interpolate, Height, All Against Truth
...
## 113. A Reprojection Error of 0.05 px Guarantees Nothing
...
## 114. Chain the Neighbours Together and You Cannot Get Back Where You Started
...
## 115. Measuring on a Real Stereo Photograph — Three Stumbles Synthesis Never Produces
...
## 116. The Convergence Basin of Point-Cloud Registration — How Far Off Can the Initial Pose Be?
...
## 117. Which Quantities Really Survive a Rotation — Auditing Invariance on a Real Coin
...
## 118. Where Is the Public Camera Looking — The Orientation of a Fixed Camera Whose Only Published Fact Is Its Position, from the Picture Itself
...
## 119. Where Is the Public Camera Looking, for Real — Hunting the Sun in 807 Road Cameras, Fixing the Heading from One Sunset and Checking It Against the Road
...
## 120. Peeling Layers With Many Wavelengths — Underdrawing, Ground, Glaze and Fading, Truth in Hand
...
## 121. Stripping Specular Reflection With Polarisation — Truth From the Fresnel Equations
...
## 122. Separating a Real Immunostain by Colour — The Watchdog Was Blind to Exactly the Error It Should Catch
...
## 123. Colour Constancy (White Balance) — No Method Works, Only Conditions Do
...
## 124. Straightening a Hand-Held Document Photo — Keystone Correction and Shadow Removal Against Ground Truth
...
## 125. Forgery Detection as an ROC — Not the One Image Found, but Detection at a Fixed False-Positive Rate
...
## 126. Craquelure networks — of three indicators, only junction degree breaks under imaging conditions
...
## 127. Camera Fingerprints (PRNU): Which Camera Took This? — The Fingerprint Grows With Frame Count and Dies at the Save Button
...
## 128. Battery cell degradation by CT — the swelling shows outside, the cause stays inside
...
## 129. Fusing two sensors into a bird's-eye grid — a calibration that passes in pixels turns into metres at range
...
## 130. CAD-to-scan deviation inspection — the fit absorbs the defect and invents a dent
...
## 131. Crop leaf area from above — folded by projection before it is ever hidden
...
## 132. Collapsing joint voids into one number — what the number drops is the shape that matters
...
## 133. Manufacturability from geometry alone — faces that sit on the threshold flip when you smooth them
...
## 134. Earthwork on a slope — align first and the scar gets shallower
...
## 135. Weighing an Animal from Silhouettes — The Error You Can Buy Down, and the One You Cannot
...
## 136. Repair the mesh, then measure — the defect count clears, the quantity does not
...
## 137. Pallet load utilization — one number gives voids and overhang the same value
...
## 138. Pipe Wall Loss on the Unwrapped Map — The Axis You Choose Eats the Invert Corrosion
...
## 139. Warpage lives in the layer history — averaging the area throws the placement away
...
## 140. Human-machine clearance — swap the body for a point, and the hazard vanishes with it
...
## 141. As-built deviation of a room — the compromise pose is handed to the innocent element
...
## 142. Re-surveying a structure year by year — when the vantage moves, decay appears to advance
...
## 143. Restoring what is missing by symmetry — the plane you assume is the lie you get
