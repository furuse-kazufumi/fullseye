...
## 57. How Much Camera Shake Can Be Undone — Make the Kernel, Apply It, Invert It, Compare
...
## 58. Does Super-Resolution Add Information? Downsample With the Truth in Hand, Restore, Count
...
## 59. Removing Haze — Ground Truth From the Scattering Model, Transmission and Airlight Scored Apart
...
## 60. Focus Stacking — The All-in-Focus Image and the Depth Map Are Different Things
...
## 61. Where CT Reconstruction Starts to Break as Projections Are Removed
...
## 62. Depth From a Light Field — A Light Field of Known Depth, Confronted With Its Nulls
...
## 63. Ranging by Counting Photons — How Many for How Many Millimetres?
...
## 64. Pseudo-colour changes what the reader decides — counting edges that are not there
...
## 65. A Growth Time-Lapse as Space-Time Connected Components
...
## 66. Counting in (x, y, t) — Vehicles Passed, Occlusion, and One Constant: L/V
...
## 67. The Arrival-Time Surface as an Isosurface in (x, y, t)
...
## 68. Particle Tracking as a (row, column, time) Volume — Mislinks Come in Two Directions
...
## 69. Template Tracking Drifts Quietly Before It Ever Loses the Target
...
## 70. Micro-Vibration of a Structure From Video — Does Motion Magnification Help You Measure?
...
## 71. Modal identification from video — frequency survives to the end, damping lies first
...
## 72. Where the Warehouse Dwell Came From — Count Waiting Without Its Kind and Everything Is Just Congestion
...
## 73. The Cold-Chain Temperature Record — Where You Taped the Logger Is the Verdict
...
## 74. Measuring the Growth, Not the Width — Rephotographing the Same Wall Changes What the Error Is
...
## 75. Did It Settle, or Did We Just Scan It Again — What Changes When You Cut at the Detection Limit
...
## 76. A Reprojection Error of 0.05 px Guarantees Nothing
...
## 77. Chain the Neighbours Together and You Cannot Get Back Where You Started
...
## 78. The Convergence Basin of Point-Cloud Registration — How Far Off Can the Initial Pose Be?
...
## 79. Measuring on a Real Stereo Photograph — Three Stumbles Synthesis Never Produces
...
## 80. Colour Constancy (White Balance) — No Method Works, Only Conditions Do
...
## 81. Peeling Layers With Many Wavelengths — Underdrawing, Ground, Glaze and Fading, Truth in Hand
...
## 82. Stripping Specular Reflection With Polarisation — Truth From the Fresnel Equations
...
## 83. Forgery Detection as an ROC — Not the One Image Found, but Detection at a Fixed False-Positive Rate
...
## 84. Straightening a Hand-Held Document Photo — Keystone Correction and Shadow Removal Against Ground Truth
...
## 85. Camera Fingerprints (PRNU): Which Camera Took This? — The Fingerprint Grows With Frame Count and Dies at the Save Button
...
## 86. Craquelure networks — of three indicators, only junction degree breaks under imaging conditions
...
## 87. Repair the mesh, then measure — the defect count clears, the quantity does not
...
## 88. Earthwork on a slope — align first and the scar gets shallower
...
## 89. CAD-to-scan deviation inspection — the fit absorbs the defect and invents a dent
...
## 90. Manufacturability from geometry alone — faces that sit on the threshold flip when you smooth them
...
## 91. Restoring what is missing by symmetry — the plane you assume is the lie you get
...
## 92. Warpage lives in the layer history — averaging the area throws the placement away
...
## 93. Fusing two sensors into a bird's-eye grid — a calibration that passes in pixels turns into metres at range
...
## 94. Collapsing joint voids into one number — what the number drops is the shape that matters
...
## 95. Battery cell degradation by CT — the swelling shows outside, the cause stays inside
...
## 96. Re-surveying a structure year by year — when the vantage moves, decay appears to advance
...
## 97. As-built deviation of a room — the compromise pose is handed to the innocent element
...
## 98. Pipe Wall Loss on the Unwrapped Map — The Axis You Choose Eats the Invert Corrosion
...
## 99. Crop leaf area from above — folded by projection before it is ever hidden
...
## 100. Human-machine clearance — swap the body for a point, and the hazard vanishes with it
...
## 101. Pallet load utilization — one number gives voids and overhang the same value
...
Ninety-nine of the 101 scripts are closed over synthetic data. On 2026-09-08 the first two real photographs entered the museum (a real stereo pair, and a real photograph of coins). For the synthetic ninety-nine, **the entry point for real data was decided before they were written**.
