...
- 2026-09-07 — Exoplanet transit from aperture photometry — depth and duration fail separately (poc_exoplanet_transit)
- 2026-09-07 — Metallographic Grain Size — The Planimetric and Intercept Methods Fall Off Different Cliffs (poc_metal_grain_size)
- 2026-09-07 — Colocalization lies under bleed-through — Pearson and Manders break in different places (poc_colocalization_crosstalk)
- 2026-09-07 — MRI Bias Field and Tissue Area — Grey and White Matter Fail in Opposite Directions, and the Sum Hides It (poc_mri_bias_field)
- 2026-09-07 — River surface velocity from an oblique video (LSPIV) — velocity error and discharge error are different numbers (poc_river_surface_velocity)
- 2026-09-07 — Camera Fingerprints (PRNU): Which Camera Took This? — The Fingerprint Grows With Frame Count and Dies at the Save Button (poc_prnu_camera_fingerprint)
...
## The wings (69 exhibits)

<!-- generated by tools/gen_wingpoc_gallery.py from docs/articles/exhibits/poc_captions.json + each PoC's figures.json. Do not edit by hand. -->
...
*↑ The measurement ―― auc_by_type (figure labels are in Japanese; the numbers are the same)*
...
*↑ The measurement ―― verdict (figure labels are in Japanese; the numbers are the same)*
...
[![map_detections](https://raw.githubusercontent.com/furuse-kazufumi/fullseye/master/docs/articles/assets/poc/poc_weld_radiograph_porosity/02_map_detections_720.jpg)](https://raw.githubusercontent.com/furuse-kazufumi/fullseye/master/docs/articles/assets/poc/poc_weld_radiograph_porosity/02_map_detections.png)

*↑ The measurement ―― map_detections (figure labels are in Japanese; the numbers are the same)*

<!-- 静止サムネ: https://raw.githubusercontent.com/furuse-kazufumi/fullseye/master/docs/articles/assets/poc/poc_weld_radiograph_porosity/01_scene_radiograph_720.jpg -->
<!-- 生成: examples/poc_weld_radiograph_porosity.py (FULLSEYE_FIGURE_DIR) / 01_scene_radiograph.png / 余盛は暗い帯、気孔は明るい斑点。背景を引いて対数を取ると弦長 × μ に戻る。 / numbers: log / added 2026-09-07 -->
...
[![by_type](https://raw.githubusercontent.com/furuse-kazufumi/fullseye/master/docs/articles/assets/poc/poc_solar_el_inspection/02_by_type_720.jpg)](https://raw.githubusercontent.com/furuse-kazufumi/fullseye/master/docs/articles/assets/poc/poc_solar_el_inspection/02_by_type.png)

*↑ The measurement ―― by_type (figure labels are in Japanese; the numbers are the same)*

<!-- 静止サムネ: https://raw.githubusercontent.com/furuse-kazufumi/fullseye/master/docs/articles/assets/poc/poc_solar_el_inspection/01_zero_point_map_720.jpg -->
<!-- 生成: examples/poc_solar_el_inspection.py (FULLSEYE_FIGURE_DIR) / 01_zero_point_map.png / 単位は % of セル面積。暗画素の 4 割はフィンガーとバスバー、3 割は結晶粒とビネッティング。 / numbers: log / added 2026-09-07 -->
...
<!-- 静止サムネ: https://raw.githubusercontent.com/furuse-kazufumi/fullseye/master/docs/articles/assets/poc/poc_solder_fillet_aoi/02_scene_grid_720.jpg -->
<!-- 生成: examples/poc_solder_fillet_aoi.py (FULLSEYE_FIGURE_DIR) / 02_scene_grid.png / フィレットの壁側は暗い。ブリッジは隣のパッドへ渡る畝、浮きは電極上面の色で分かる。 / numbers: log / added 2026-09-07 -->
...
## 14. Dimensional Inspection of a Machined Part — Bias and Scatter as Two Numbers
...
## 15. Gear Tooth Metrology — Eccentricity Is Order 1, Teeth Are Order z
...
*↑ The measurement ―― profile (figure labels are in Japanese; the numbers are the same)*
...
## 16. How Far Sa / Sq / Sz Survive Sampling and Cutoff
...
## 17. How Accurately a White-Light Interferometer Measures a Nanometre Step
...
## 18. Strain From Speckle Images (DIC)
...
## 19. Strain History in a Creep Test — Cumulative or Direct?
...
## 20. Stress by Photoelasticity — Unwrapping Fails First at the Isotropic Point
...
## 21. Measuring Bilateral Asymmetry — The Symmetry Plane Gets Dragged by the Deformation
...
## 22. Particle Size Distribution From Images — Merging and Edge Cuts Pull Opposite Ways and Cancel
...
## 23. Fibre Orientation Distribution — Angles Repeat Every 180 Degrees, and a Naive Mean Is 90 Degrees Off
...
*↑ The measurement ―― wrap (figure labels are in Japanese; the numbers are the same)*
...
## 24. Metallographic Grain Size — The Planimetric and Intercept Methods Fall Off Different Cliffs
...
*↑ The measurement ―― controls (figure labels are in Japanese; the numbers are the same)*
...
## 25. Pitch, Flank Angle and Pitch Diameter From a Thread Silhouette — Tilt Shows Up With Opposite Signs on the Two Flanks
...
## 26. Counting Overlapping Cells — Count, Over-Segmentation and Under-Segmentation as Three Numbers
...
## 27. Ploidy From Integrated Nuclear Intensity — Area Cannot Separate It
...
## 28. Extracting a Vessel Network — Spurs, Overestimated Radii Near Branches, and a Fragile Exponent
...
*↑ The measurement ―― prune (figure labels are in Japanese; the numbers are the same)*
...
## 29. Wound Area Over Time — Calibration Error Enters the Area Squared
...
## 30. Colocalization lies under bleed-through — Pearson and Manders break in different places
...
*↑ The measurement ―― scene_unmixed (figure labels are in Japanese; the numbers are the same)*
...
## 31. MRI Bias Field and Tissue Area — Grey and White Matter Fail in Opposite Directions, and the Sum Hides It
...
## 32. Trabecular Thickness, Separation and Bone Volume Fraction — The Plate Model and the Direct Method Disagree on the Same Image
...
<!-- 静止サムネ: https://raw.githubusercontent.com/furuse-kazufumi/fullseye/master/docs/articles/assets/poc/poc_bone_trabecular_thickness/01_scene_truth_720.jpg -->
<!-- 生成: examples/poc_bone_trabecular_thickness.py (FULLSEYE_FIGURE_DIR) / 01_scene_truth.png /  / numbers: log / added 2026-09-07 -->
...
## 33. How Many Frames for What Photometric Precision?
...
## 34. To What Fraction of a Pixel Can a Star Be Located, and Where Is the Cliff?
...
## 35. Where Is the Edge of a Limb-Darkened Disc? The 50 % Rule Reads the Radius Small
...
*↑ The measurement ―― bias_vs_u (figure labels are in Japanese; the numbers are the same)*
...
## 36. All-Sky Cloud Cover — Counting Pixels Is Biased by Position
...
## 37. Sea-Ice Concentration — The Answer Depends on How Mixed Pixels Are Counted
...
*↑ The measurement ―― bias_vs_threshold (figure labels are in Japanese; the numbers are the same)*
...
## 38. Counting Crop Green — Ground Truth as Per-Pixel Leaf Area Fraction
...
## 39. Measuring Terrain — Slope, Flow and Insolation Against Closed Forms
...
## 40. River Stage From an Oblique Photo — Ignoring Perspective Bends the Row-Number Error Into an Arc
...
*↑ The measurement ―― bias_vs_level (figure labels are in Japanese; the numbers are the same)*
...
## 41. Exoplanet transit from aperture photometry — depth and duration fail separately
...
## 42. River surface velocity from an oblique video (LSPIV) — velocity error and discharge error are different numbers
...
*↑ The measurement ―― frames_oblique (figure labels are in Japanese; the numbers are the same)*
...
## 43. Change detection under misregistration — false positives are edge bands, with a cliff
...
<!-- 静止サムネ: https://raw.githubusercontent.com/furuse-kazufumi/fullseye/master/docs/articles/assets/poc/poc_change_detection_misreg/03_map_fp_shift_720.jpg -->
<!-- 生成: examples/poc_change_detection_misreg.py (FULLSEYE_FIGURE_DIR) / 03_map_fp_shift.png / ずれ 0 では変化だけ。0.5 px から強いエッジ(屋根・道路)が帯として出る。 / numbers: log / added 2026-09-07 -->
...
## 44. Leaf disease severity — colour axes survive the lighting; the grade is decided by the leaf mask and the edge convention
...
<!-- 静止サムネ: https://raw.githubusercontent.com/furuse-kazufumi/fullseye/master/docs/articles/assets/poc/poc_leaf_disease_area/01_scene_720.jpg -->
<!-- 生成: examples/poc_leaf_disease_area.py (FULLSEYE_FIGURE_DIR) / 01_scene.png / 病斑と土は同じ褐色。葉を色度で切り、葉の中を a* で切る。 / numbers: log / added 2026-09-07 -->
...
## 45. Counting tree rings and extracting the width series — ring count and width correlation fail separately
...
<!-- 静止サムネ: https://raw.githubusercontent.com/furuse-kazufumi/fullseye/master/docs/articles/assets/poc/poc_tree_ring_dendro/01_scene_720.jpg -->
<!-- 生成: examples/poc_tree_ring_dendro.py (FULLSEYE_FIGURE_DIR) / 01_scene.png / 幅系列は AR(1) の気候信号、偏心成長 ±20 %、周方向のうねり、割れ目、腐朽、木目、ぼけ、雑音を仕込んである。 / numbers: log / added 2026-09-07 -->
...
## 46. How Much Camera Shake Can Be Undone — Make the Kernel, Apply It, Invert It, Compare
...
## 47. Does Super-Resolution Add Information? Downsample With the Truth in Hand, Restore, Count
...
## 48. Removing Haze — Ground Truth From the Scattering Model, Transmission and Airlight Scored Apart
...
## 49. Focus Stacking — The All-in-Focus Image and the Depth Map Are Different Things
...
## 50. Where CT Reconstruction Starts to Break as Projections Are Removed
...
## 51. Depth From a Light Field — A Light Field of Known Depth, Confronted With Its Nulls
...
## 52. Ranging by Counting Photons — How Many for How Many Millimetres?
...
## 53. A Growth Time-Lapse as Space-Time Connected Components
...
## 54. Counting in (x, y, t) — Vehicles Passed, Occlusion, and One Constant: L/V
...
*↑ The measurement ―― scene (figure labels are in Japanese; the numbers are the same)*
...
## 55. The Arrival-Time Surface as an Isosurface in (x, y, t)
...
## 56. Particle Tracking as a (row, column, time) Volume — Mislinks Come in Two Directions
...
## 57. Template Tracking Drifts Quietly Before It Ever Loses the Target
...
## 58. Micro-Vibration of a Structure From Video — Does Motion Magnification Help You Measure?
...
## 59. Modal identification from video — frequency survives to the end, damping lies first
...
[![frames](https://raw.githubusercontent.com/furuse-kazufumi/fullseye/master/docs/articles/assets/poc/poc_beam_modal_video/02_frames_720.jpg)](https://raw.githubusercontent.com/furuse-kazufumi/fullseye/master/docs/articles/assets/poc/poc_beam_modal_video/02_frames.png)

*↑ The measurement ―― frames (figure labels are in Japanese; the numbers are the same)*

<!-- 静止サムネ: https://raw.githubusercontent.com/furuse-kazufumi/fullseye/master/docs/articles/assets/poc/poc_beam_modal_video/01_scene_720.jpg -->
<!-- 生成: examples/poc_beam_modal_video.py (FULLSEYE_FIGURE_DIR) / 01_scene.png / 左上: 測る動画の 1 枚目(雑音・ちらつき・手ぶれ入り)。右上: 同じ梁を見える振幅で。下段: 位相法の変位場と重み(模様の無い所は票を持たない)。 / numbers: log / added 2026-09-07 -->
...
## 60. A Reprojection Error of 0.05 px Guarantees Nothing
...
## 61. Chain the Neighbours Together and You Cannot Get Back Where You Started
...
## 62. The Convergence Basin of Point-Cloud Registration — How Far Off Can the Initial Pose Be?
...
## 63. Colour Constancy (White Balance) — No Method Works, Only Conditions Do
...
## 64. Peeling Layers With Many Wavelengths — Underdrawing, Ground, Glaze and Fading, Truth in Hand
...
## 65. Stripping Specular Reflection With Polarisation — Truth From the Fresnel Equations
...
## 66. Forgery Detection as an ROC — Not the One Image Found, but Detection at a Fixed False-Positive Rate
...
## 67. Straightening a Hand-Held Document Photo — Keystone Correction and Shadow Removal Against Ground Truth
...
## 68. Camera Fingerprints (PRNU): Which Camera Took This? — The Fingerprint Grows With Frame Count and Dies at the Save Button
...
## 69. Craquelure networks — of three indicators, only junction degree breaks under imaging conditions
...
<!-- 静止サムネ: https://raw.githubusercontent.com/furuse-kazufumi/fullseye/master/docs/articles/assets/poc/poc_fresco_craquelure/07_scene_720.jpg -->
<!-- 生成: examples/poc_fresco_craquelure.py (FULLSEYE_FIGURE_DIR) / 07_scene.png / 絵の具の色斑 + ニスの光沢むら + ぼけ + 雑音。斜光は溝の片側を影にする。 / numbers: log / added 2026-09-07 -->
...
All 53 scripts are closed over synthetic data, but **the entry point for real data was decided before they were written**.
...
One more open question. The thesis pattern, two errors of opposite sign, appeared in seven PoCs from unrelated physics. Does it appear on real data too, once the factors the synthesis left out come into play? Or did it only balance so neatly because the data were synthetic? Only the terrain PoC has been run on real elevation data so far, and only for timing; the accuracy scoring is still to come. That is where the next walk goes.

---

### How this museum was made

The questions each PoC asks ('how much does that one line lie', 'do not collapse read rate into one number', 'does merging look early or late') and the unease about results ('a null baseline below the theoretical floor is wrong', 'an area classifier improving under blur means the measured quantity has switched') came from me, and I set the direction. Implementation, parameter sweeps, added controls and the adversarial re-checks that disproved my own predictions were delegated to Claude Code. Every 'the prediction was wrong' in a docstring records my prediction being overturned by the AI's measurement; the reverse also happened, where I distrusted the AI's first draft and had it rewritten ('the gate is dead' → it works as designed without distortion), and those round trips are kept.

Thank you for reading. If you run the one PoC in your own field and the cliff lands somewhere other than where your experience says it should, that is the conversation I most want to have.
