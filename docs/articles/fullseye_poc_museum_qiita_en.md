...
- 2026-09-14 — Matching Full 2-D Inspection to Sampled 3-D Inspection — A Grid Overlaps Itself (poc_aoi_ct_traceability)
- 2026-09-14 — Is the Process in Control, and Is It Capable? — Statistical Process Control from Closed-Form Alone (poc_spc)
- 2026-09-13 — The Fly's Compound Eye Is a Light-Field Sensor — Neural Superposition Pays Only Up to the Knee (poc_compound_eye)
- 2026-09-13 — The Fly's Visual Front End as a Chain of Operators — Turning and Walking Through a Synthetic Sky, What Can and Cannot Be Read (poc_fly_vision)
- 2026-09-09 — How Faint a Defect Can Still Be Found — Planting a Known Truth in a Real Background (poc_real_defect_floor)

## The wings (124 exhibits)
...
## 56. All-Sky Cloud Cover — Counting Pixels Is Biased by Position
...
## 57. How Many Frames for What Photometric Precision?
...
## 58. Change detection under misregistration — false positives are edge bands, with a cliff
...
## 59. A 3-D Thermal Field from Sparse Sensors — The Grid's Blind Spot Erases a Rack
...
## 60. Measuring Terrain — Slope, Flow and Insolation Against Closed Forms
...
## 61. Exoplanet transit from aperture photometry — depth and duration fail separately
...
## 62. Coordinates Go Wrong by Tens of Metres While Still Looking Plausible
...
## 64. Drone Thermography of a PV Plant — You Think You Are Measuring Temperature Difference, but You Are Measuring Wind and Viewing Angle
...
## 65. Planting Known Stars in a Real Deep Field — Contamination Lies About the Measurement and the Confidence in the Same Direction
...
## 66. River surface velocity from an oblique video (LSPIV) — velocity error and discharge error are different numbers
...
## 67. Sea-Ice Concentration — The Answer Depends on How Mixed Pixels Are Counted
...
## 69. Where Is the Edge of a Limb-Darkened Disc? The 50 % Rule Reads the Radius Small
...
## 70. To What Fraction of a Pixel Can a Star Be Located, and Where Is the Cliff?
...
## 71. Counting tree rings and extracting the width series — ring count and width correlation fail separately
...
## 72. Counting Crop Green — Ground Truth as Per-Pixel Leaf Area Fraction
...
## 73. River Stage From an Oblique Photo — Ignoring Perspective Bends the Row-Number Error Into an Arc
...
## 74. How Much Camera Shake Can Be Undone — Make the Kernel, Apply It, Invert It, Compare
...
## 77. Where CT Reconstruction Starts to Break as Projections Are Removed
...
## 78. Removing Haze — Ground Truth From the Scattering Model, Transmission and Airlight Scored Apart
...
## 79. Ranging by Counting Photons — How Many for How Many Millimetres?
...
## 80. The Fly's Visual Front End as a Chain of Operators — Turning and Walking Through a Synthetic Sky, What Can and Cannot Be Read
...
## 81. Focus Stacking — The All-in-Focus Image and the Depth Map Are Different Things
...
## 82. Depth From a Light Field — A Light Field of Known Depth, Confronted With Its Nulls
...
## 83. Deblurring a Real Photograph — Three Rulers, Three Different Winners
...
## 84. Does Super-Resolution Add Information? Downsample With the Truth in Hand, Restore, Count
...
## 85. Modal identification from video — frequency survives to the end, damping lies first
...
## 88. Micro-Vibration of a Structure From Video — Does Motion Magnification Help You Measure?
...
## 89. Particle Tracking as a (row, column, time) Volume — Mislinks Come in Two Directions
...
## 90. Did It Settle, or Did We Just Scan It Again — What Changes When You Cut at the Detection Limit
...
## 91. Template Tracking Drifts Quietly Before It Ever Loses the Target
...
## 92. A Growth Time-Lapse as Space-Time Connected Components
...
## 93. Counting in (x, y, t) — Vehicles Passed, Occlusion, and One Constant: L/V
...
## 94. Where the Warehouse Dwell Came From — Count Waiting Without Its Kind and Everything Is Just Congestion
...
## 95. The Arrival-Time Surface as an Isosurface in (x, y, t)
...
## 96. A Reprojection Error of 0.05 px Guarantees Nothing
...
## 97. Chain the Neighbours Together and You Cannot Get Back Where You Started
...
## 98. Measuring on a Real Stereo Photograph — Three Stumbles Synthesis Never Produces
...
## 99. The Convergence Basin of Point-Cloud Registration — How Far Off Can the Initial Pose Be?
...
## 100. Which Quantities Really Survive a Rotation — Auditing Invariance on a Real Coin
...
## 101. Peeling Layers With Many Wavelengths — Underdrawing, Ground, Glaze and Fading, Truth in Hand
...
## 102. Stripping Specular Reflection With Polarisation — Truth From the Fresnel Equations
...
## 103. Separating a Real Immunostain by Colour — The Watchdog Was Blind to Exactly the Error It Should Catch
...
## 104. Colour Constancy (White Balance) — No Method Works, Only Conditions Do
...
## 105. Straightening a Hand-Held Document Photo — Keystone Correction and Shadow Removal Against Ground Truth
...
## 106. Forgery Detection as an ROC — Not the One Image Found, but Detection at a Fixed False-Positive Rate
...
## 107. Craquelure networks — of three indicators, only junction degree breaks under imaging conditions
...
## 108. Camera Fingerprints (PRNU): Which Camera Took This? — The Fingerprint Grows With Frame Count and Dies at the Save Button
...
## 109. Battery cell degradation by CT — the swelling shows outside, the cause stays inside
...
## 110. Fusing two sensors into a bird's-eye grid — a calibration that passes in pixels turns into metres at range
...
## 111. CAD-to-scan deviation inspection — the fit absorbs the defect and invents a dent
...
## 112. Crop leaf area from above — folded by projection before it is ever hidden
...
## 113. Collapsing joint voids into one number — what the number drops is the shape that matters
...
## 114. Manufacturability from geometry alone — faces that sit on the threshold flip when you smooth them
...
## 115. Earthwork on a slope — align first and the scar gets shallower
...
## 116. Weighing an Animal from Silhouettes — The Error You Can Buy Down, and the One You Cannot
...
## 117. Repair the mesh, then measure — the defect count clears, the quantity does not
...
## 118. Pallet load utilization — one number gives voids and overhang the same value
...
## 119. Pipe Wall Loss on the Unwrapped Map — The Axis You Choose Eats the Invert Corrosion
...
## 120. Warpage lives in the layer history — averaging the area throws the placement away
...
## 121. Human-machine clearance — swap the body for a point, and the hazard vanishes with it
...
## 122. As-built deviation of a room — the compromise pose is handed to the innocent element
...
## 123. Re-surveying a structure year by year — when the vantage moves, decay appears to advance
...
## 124. Restoring what is missing by symmetry — the plane you assume is the lie you get
