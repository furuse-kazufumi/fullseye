...
*↑ The measurement ―― 同じ欠陥を、振幅 0.02 から 1.20 まで上げていく。左=実写の brick、右=**残差 σ を揃えた**合成の地。雑音の量は同じなのに、右のほうが先に見えてくる。 (figure labels are in Japanese; the numbers are the same)*
...
Ops used (notes): [`laplace_of_gauss`](https://furuse.work/ops/2d/edges/laplace_of_gauss.html) · [`reflect`](https://furuse.work/ops/3d/optics/reflect.html)
...
## 25. Dimensional Inspection of a Machined Part — Bias and Scatter as Two Numbers
...
## 26. Gear Tooth Metrology — Eccentricity Is Order 1, Teeth Are Order z
...
## 27. How Far Sa / Sq / Sz Survive Sampling and Cutoff
...
## 28. How Accurately a White-Light Interferometer Measures a Nanometre Step
...
## 29. Strain From Speckle Images (DIC)
...
## 30. Strain History in a Creep Test — Cumulative or Direct?
...
## 31. Stress by Photoelasticity — Unwrapping Fails First at the Isotropic Point
...
## 32. Measuring Bilateral Asymmetry — The Symmetry Plane Gets Dragged by the Deformation
...
## 33. Particle Size Distribution From Images — Merging and Edge Cuts Pull Opposite Ways and Cancel
...
## 35. Metallographic Grain Size — The Planimetric and Intercept Methods Fall Off Different Cliffs
...
## 36. Pitch, Flank Angle and Pitch Diameter From a Thread Silhouette — Tilt Shows Up With Opposite Signs on the Two Flanks
...
## 37. As-built wall deviation — the bounding box measures the room's heading, not its size
...
## 38. Measuring electrode breathing in microns — sub-pixel is not enough
...
## 39. Die tilt and TSV overlay from one CT — tilt fakes rotation too
...
## 40. Counting and Measuring Real Coins — A Correct Answer Is Not a Safe One
...
## 42. Stockpile Inventory — The Answer Is Fixed by the Ground Nobody Measured
...
## 43. Why the Seafloor Smiles — A Wrong Sound-Speed Profile Breaks Only the Outer Beams
...
## 44. Counting Overlapping Cells — Count, Over-Segmentation and Under-Segmentation as Three Numbers
...
## 45. Ploidy From Integrated Nuclear Intensity — Area Cannot Separate It
...
## 46. Extracting a Vessel Network — Spurs, Overestimated Radii Near Branches, and a Fragile Exponent
...
## 47. Wound Area Over Time — Calibration Error Enters the Area Squared
...
## 51. How Many Frames for What Photometric Precision?
...
## 52. To What Fraction of a Pixel Can a Star Be Located, and Where Is the Cliff?
...
## 53. Where Is the Edge of a Limb-Darkened Disc? The 50 % Rule Reads the Radius Small
...
## 55. Sea-Ice Concentration — The Answer Depends on How Mixed Pixels Are Counted
...
## 56. Counting Crop Green — Ground Truth as Per-Pixel Leaf Area Fraction
...
## 58. River Stage From an Oblique Photo — Ignoring Perspective Bends the Row-Number Error Into an Arc
...
## 60. River surface velocity from an oblique video (LSPIV) — velocity error and discharge error are different numbers
...
## 62. Leaf disease severity — colour axes survive the lighting; the grade is decided by the leaf mask and the edge convention
...
## 63. Counting tree rings and extracting the width series — ring count and width correlation fail separately
...
## 67. Sweep Width — One Number Measured from Aerial Images Decides Whether the Search Works
...
## 69. How Much Camera Shake Can Be Undone — Make the Kernel, Apply It, Invert It, Compare
...
## 70. Does Super-Resolution Add Information? Downsample With the Truth in Hand, Restore, Count
...
## 71. Removing Haze — Ground Truth From the Scattering Model, Transmission and Airlight Scored Apart
...
## 72. Focus Stacking — The All-in-Focus Image and the Depth Map Are Different Things
...
## 73. Where CT Reconstruction Starts to Break as Projections Are Removed
...
## 74. Depth From a Light Field — A Light Field of Known Depth, Confronted With Its Nulls
...
## 75. Ranging by Counting Photons — How Many for How Many Millimetres?
...
## 76. Pseudo-colour changes what the reader decides — counting edges that are not there
...
## 77. Deblurring a Real Photograph — Three Rulers, Three Different Winners
