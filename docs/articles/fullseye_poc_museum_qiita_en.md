...
## 61. All-Sky Cloud Cover — Counting Pixels Is Biased by Position
...
## 62. How Many Frames for What Photometric Precision?
...
## 63. Change detection under misregistration — false positives are edge bands, with a cliff
...
## 64. A 3-D Thermal Field from Sparse Sensors — The Grid's Blind Spot Erases a Rack
...
## 65. Measuring Terrain — Slope, Flow and Insolation Against Closed Forms
...
## 66. Exoplanet transit from aperture photometry — depth and duration fail separately
...
## 68. Leaf disease severity — colour axes survive the lighting; the grade is decided by the leaf mask and the edge convention
...
## 69. Drone Thermography of a PV Plant — You Think You Are Measuring Temperature Difference, but You Are Measuring Wind and Viewing Angle
...
## 70. Planting Known Stars in a Real Deep Field — Contamination Lies About the Measurement and the Confidence in the Same Direction
...
## 71. River surface velocity from an oblique video (LSPIV) — velocity error and discharge error are different numbers
...
## 72. Sea-Ice Concentration — The Answer Depends on How Mixed Pixels Are Counted
...
## 73. Sweep Width — One Number Measured from Aerial Images Decides Whether the Search Works
...
## 74. Where Is the Edge of a Limb-Darkened Disc? The 50 % Rule Reads the Radius Small
...
## 75. To What Fraction of a Pixel Can a Star Be Located, and Where Is the Cliff?
...
## 76. Counting tree rings and extracting the width series — ring count and width correlation fail separately
...
## 77. Counting Crop Green — Ground Truth as Per-Pixel Leaf Area Fraction
...
## 78. River Stage From an Oblique Photo — Ignoring Perspective Bends the Row-Number Error Into an Arc
...
## 79. How Much Camera Shake Can Be Undone — Make the Kernel, Apply It, Invert It, Compare
...
## 80. Pseudo-colour changes what the reader decides — counting edges that are not there
...
## 81. The Fly's Compound Eye Is a Light-Field Sensor — Neural Superposition Pays Only Up to the Knee
...
## 82. Where CT Reconstruction Starts to Break as Projections Are Removed
...
## 83. Removing Haze — Ground Truth From the Scattering Model, Transmission and Airlight Scored Apart
...
## 84. Ranging by Counting Photons — How Many for How Many Millimetres?
...
## 85. The Fly's Visual Front End as a Chain of Operators — Turning and Walking Through a Synthetic Sky, What Can and Cannot Be Read
...
## 86. Focus Stacking — The All-in-Focus Image and the Depth Map Are Different Things
...
## 87. Depth From a Light Field — A Light Field of Known Depth, Confronted With Its Nulls
...
## 88. Deblurring a Real Photograph — Three Rulers, Three Different Winners
...
## 89. Does Super-Resolution Add Information? Downsample With the Truth in Hand, Restore, Count
...
## 90. Modal identification from video — frequency survives to the end, damping lies first
...
## 91. The Cold-Chain Temperature Record — Where You Taped the Logger Is the Verdict
...
## 92. Measuring the Growth, Not the Width — Rephotographing the Same Wall Changes What the Error Is
...
## 93. Micro-Vibration of a Structure From Video — Does Motion Magnification Help You Measure?
...
## 94. Particle Tracking as a (row, column, time) Volume — Mislinks Come in Two Directions
...
## 95. Did It Settle, or Did We Just Scan It Again — What Changes When You Cut at the Detection Limit
...
## 96. Template Tracking Drifts Quietly Before It Ever Loses the Target
...
## 97. A Growth Time-Lapse as Space-Time Connected Components
...
## 98. Counting in (x, y, t) — Vehicles Passed, Occlusion, and One Constant: L/V
...
## 99. Where the Warehouse Dwell Came From — Count Waiting Without Its Kind and Everything Is Just Congestion
...
## 100. The Arrival-Time Surface as an Isosurface in (x, y, t)
...
## 101. A Clip as a Space-Time Cube — What Passed Where, and When, in One Solid
...
## 102. Living Tissue in 3D+t Without a Generator — Magnify, Flow, Interpolate, Height, All Against Truth
...
## 103. A Reprojection Error of 0.05 px Guarantees Nothing
...
## 104. Chain the Neighbours Together and You Cannot Get Back Where You Started
...
## 105. Measuring on a Real Stereo Photograph — Three Stumbles Synthesis Never Produces
...
## 106. The Convergence Basin of Point-Cloud Registration — How Far Off Can the Initial Pose Be?
...
## 107. Which Quantities Really Survive a Rotation — Auditing Invariance on a Real Coin
...
## 108. Peeling Layers With Many Wavelengths — Underdrawing, Ground, Glaze and Fading, Truth in Hand
...
## 109. Stripping Specular Reflection With Polarisation — Truth From the Fresnel Equations
...
## 110. Separating a Real Immunostain by Colour — The Watchdog Was Blind to Exactly the Error It Should Catch
...
## 111. Colour Constancy (White Balance) — No Method Works, Only Conditions Do
...
## 112. Straightening a Hand-Held Document Photo — Keystone Correction and Shadow Removal Against Ground Truth
...
## 113. Forgery Detection as an ROC — Not the One Image Found, but Detection at a Fixed False-Positive Rate
...
## 114. Craquelure networks — of three indicators, only junction degree breaks under imaging conditions
...
## 115. Camera Fingerprints (PRNU): Which Camera Took This? — The Fingerprint Grows With Frame Count and Dies at the Save Button
...
## 116. Battery cell degradation by CT — the swelling shows outside, the cause stays inside
...
## 117. Fusing two sensors into a bird's-eye grid — a calibration that passes in pixels turns into metres at range
...
## 118. CAD-to-scan deviation inspection — the fit absorbs the defect and invents a dent
...
## 119. Crop leaf area from above — folded by projection before it is ever hidden
...
## 120. Collapsing joint voids into one number — what the number drops is the shape that matters
...
## 121. Manufacturability from geometry alone — faces that sit on the threshold flip when you smooth them
...
## 122. Earthwork on a slope — align first and the scar gets shallower
...
## 123. Weighing an Animal from Silhouettes — The Error You Can Buy Down, and the One You Cannot
...
## 124. Repair the mesh, then measure — the defect count clears, the quantity does not
...
## 125. Pallet load utilization — one number gives voids and overhang the same value
...
## 126. Pipe Wall Loss on the Unwrapped Map — The Axis You Choose Eats the Invert Corrosion
...
## 127. Warpage lives in the layer history — averaging the area throws the placement away
...
## 128. Human-machine clearance — swap the body for a point, and the hazard vanishes with it
...
## 129. As-built deviation of a room — the compromise pose is handed to the innocent element
...
## 130. Re-surveying a structure year by year — when the vantage moves, decay appears to advance
...
## 131. Restoring what is missing by symmetry — the plane you assume is the lie you get
