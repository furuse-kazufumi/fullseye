...
| `academic_bio_neuron.png` | 生物学 | AI-generated simulated data (gemini-2.5-flash-image) | **Yes** (gemini-2.5-flash-image) | AI 生成模擬データ(Google gemini-2.5-flash-image)— 実データではない | rgb1_to_gray, cv_clahe, sk_frangi |
