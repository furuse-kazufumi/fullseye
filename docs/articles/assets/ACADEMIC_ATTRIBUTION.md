...
実データはすべて public domain / CC0 のみを使用。
...
| `academic_bio_diatoms.png` | 生物学 | AI-generated simulated data (gemini-2.5-flash-image) | **Yes** (gemini-2.5-flash-image) | AI 生成模擬データ(Google gemini-2.5-flash-image)— 実データではない | rgb1_to_gray, segment_objects(otsu), colorize_labels |
...
| `academic_bot_pollen.png` | 植物学 | AI-generated simulated data (gemini-2.5-flash-image) | **Yes** (gemini-2.5-flash-image) | AI 生成模擬データ(Google gemini-2.5-flash-image)— 実データではない | rgb1_to_gray, segment_objects(otsu), colorize_labels |
...
| `academic_med_blood_smear.png` | 医学 | AI-generated simulated data (gemini-2.5-flash-image) | **Yes** (gemini-2.5-flash-image) | AI 生成模擬データ(Google gemini-2.5-flash-image)— 実データではない | rgb1_to_gray, segment_objects(otsu), colorize_labels |
...
2026-08-30: BBBC001(HT29 細胞)展示はライセンス確認の結果 CC BY-NC-SA 3.0 と判明したため除去(当初 CC-BY 3.0 と誤記)。NC/SA 条項が本リポジトリの Apache-2.0+商用デュアルライセンスと非両立。
