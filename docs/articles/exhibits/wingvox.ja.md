...
- GIF: `docs/articles/assets/media/wingvox_slice_flow.gif` (24 コマ, 288x456 px, 0.26 MB)
...
- GIF: `docs/articles/assets/media/wingvox_flicker.gif` (24 コマ, 496x420 px, 0.34 MB)
...
- PNG (タイル): `docs/articles/assets/wingvox_connectivity.png` (378x368 px, 26 kB, 6 パネル / 3 列)
- サムネ(記事はこちらを表示): `docs/articles/assets/wingvox_connectivity_thumb.jpg` (31 kB)
...
- GIF: `docs/articles/assets/media/wingvox_sieve.gif` (17 コマ, 288x458 px, 0.23 MB)
...
*↑ **元の CT に色ラベルを重ねる ―― α を掃引する** ―― 断面 z=8 で alpha を 0 から 1 へ往復させる。前景の平均変化は 0.0000 → 0.2620 と alpha に**直線**で比例し、**背景の変化は alpha に依らず 0.0000**(色はラベルの上にしか乗らない)。輪郭だけ塗る ``mode='boundary'`` なら前景 3128 ボクセルのうち 1648(52.7 %)しか塗らないので、下の構造が完全に見える。 使用 op: `vol_label`, `vol_label_overlay`, `vol_label_slice_rgb`。*

- GIF: `docs/articles/assets/media/wingvox_overlay_alpha.gif` (40 コマ, 288x458 px, 1.32 MB)
...
- GIF: `docs/articles/assets/media/wingvox_mesh_turntable.gif` (24 コマ, 300x450 px, 0.35 MB)
...
- PNG (原寸 1 枚): `docs/articles/assets/wingvox_legend.png` (760x550 px, 84 kB)
- サムネ(記事はこちらを表示): `docs/articles/assets/wingvox_legend_thumb.jpg` (82 kB)
