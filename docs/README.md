...
**ノートの中身の実測**: 2188 本のうち、実行できる例が付いているのは **2128 本**(60 本は例ゼロ)、使い方の説明が 120 字以上あるのは **2135 本**(53 本は 1 行の要約だけ)。構造(呼び出し・型・次に繋がる op)は 2188 本すべてにある。
