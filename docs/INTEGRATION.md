...
What this is **not**: it is not the Python library (1,996 operators in the machine-readable
...
ledgers (1,048 operators whose inputs are point clouds, signals, tables …) and the n-ary
