...
What this is **not**: it is not the Python library (2,020 operators in the machine-readable
...
ledgers (1,072 operators whose inputs are point clouds, signals, tables …) and the n-ary
