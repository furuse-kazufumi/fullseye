...
What this is **not**: it is not the Python library (2,177 operators in the machine-readable
...
ledgers (1,228 operators whose inputs are point clouds, signals, tables …) and the n-ary
