...
What this is **not**: it is not the Python library (2,051 operators in the machine-readable
...
ledgers (1,103 operators whose inputs are point clouds, signals, tables …) and the n-ary
