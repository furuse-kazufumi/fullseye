...
What this is **not**: it is not the Python library (2,072 operators in the machine-readable
...
ledgers (1,124 operators whose inputs are point clouds, signals, tables …) and the n-ary
