...
What this is **not**: it is not the Python library (2,097 operators in the machine-readable
...
ledgers (1,149 operators whose inputs are point clouds, signals, tables …) and the n-ary
