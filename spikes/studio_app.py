...
class StudioWindow(QtWidgets.QMainWindow):
    def __init__(self) -> None:
        ...
        self.sim_gsplat_btn.setToolTip("MJCF をオービット撮影→純torch 3DGS 学習(GPU venv, 別プロセス)→全周GIF")
        self.sim_gsplat_btn.clicked.connect(self._train_3dgs)
        sb.addWidget(self.sim_mesh_btn); sb.addWidget(self.sim_cloud_btn); sb.addWidget(self.sim_gsplat_btn)
        sl.addWidget(sbtns)
