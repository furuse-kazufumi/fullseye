...
Fullseye ships **2153 operator notes** in **40 families** — one generated Markdown note per registered operator — plus **56 family guides**. **The notes are the knowledge base**: retrieve first, then write code.
...
**2d** 949 · **3d** 372 · **optics** 131 · **math** 55 · **annotate** 51 · **gfx2d** 44 · **oned** 42 · **reprconv** 42 · **conngraph** 28 · **piv** 26 · **dem** 25 · **imgmetrics** 24 · **printpath** 23 · **acoustics** 20 · **quat** 19 · **lightfield** 17 · **photon** 17 · **tomography** 17 · **flyvision** 16 · **imgforensics** 16 · **shape2d** 16 · **shapestat** 16 · **videostream** 16 · **astrostack** 14 · **live4d** 14 · **measure1d** 14 · **spc** 14 · **specular** 13 · **profile** 12 · **colortransport** 11 · **volcolor** 11 · **blob** 10 · **geocam** 9 · **interferometry** 9 · **motionmag** 9 · **rangedoppler** 8 · **emproof** 7 · **roughness** 6 · **videocube** 6 · **cadmap** 4.

★ `2d` and `3d` hold 1321 of the 2153 notes, so **grepping only those two directories misses 832**. Among what it misses are the 15 physical-measurement families (347 notes) that are the reason to reach for this library instead of a general-purpose CV package: `optics` (131), `piv` (26), `dem` (25), `acoustics` (20), `quat` (19), `lightfield` (17), `photon` (17), `tomography` (17), `imgforensics` (16), `astrostack` (14), `specular` (13), `interferometry` (9), `motionmag` (9), `rangedoppler` (8), `roughness` (6). Start at `docs/ops/INDEX.md`, which lists every family with its size.
