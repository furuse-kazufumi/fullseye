...
Fullseye ships **1912 operator notes** in **32 families** — one generated Markdown note per registered operator — plus **49 family guides**. **The notes are the knowledge base**: retrieve first, then write code.
