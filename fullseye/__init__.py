...
with warnings.catch_warnings():
    ...
    from api import (  # noqa: E402,F401
        ...
        distort_points, undistort_points, distort_image, undistort_image, estimate_distortion, stereo_rectify,
        camera_calibration,
        ...
        PrecisionUnion,
        # 構造色・ガラス/鏡面・加工面(2026-09-04): 色を塗らず**波長から**作る族。
        cie_xyz_from_wavelength, spectrum_to_srgb, thin_film_reflectance,
        grating_wavelengths, grating_rgb, thin_film_rgb, ward_anisotropic,
        fresnel_dielectric, fresnel_conductor, brewster_angle_deg, critical_angle_deg,
        metal_optical_constants, metal_mirror_rgb, beer_lambert_transmittance,
        slab_transmittance, refract_rays, prism_min_deviation_deg,
        finish_catalog, tangent_field, micro_normals, blast_normals, finish_shade,
        material_catalog, oren_nayar, clearcoat_shade, metallic_flake_normals,
        sheen_shade, weave_normals, wood_grain, wetness, corrosion_mask,
    ...
    poly_fit, poly_eval, poly_roots,
        ...
        acoustics, interferometry, flyvision, spc,
        ...
        metriccontract, fssystem, fsthreads, blas_threads,
        ...
        glyphops, glyph_fonts, glyph_render, glyph_render_text, glyph_normalise,
        ...
        annotate_text_path, annotate_table_layout, annotate_table,
        annotate_invert_visibility, annotate_invert,
        annotate_invert_path, annotate_colorbar, annotate_panel_label,
        annotate_figure_grid_layout, annotate_figure_grid,
        annotate3d,
        meshres, mesh_edge_stats, mesh_detail_map, mesh_split_long_edges, mesh_isotropic_remesh,
        ...
        flush_buffer, default_text_metrics, measured_text_metrics,
        COMMAND_SPECS, TEXT_ADVANCE_RATIO,
...
__all__ = [
    ...
    "fundamental_matrix", "essential_matrix", "essential_from_fundamental",
    "decompose_essential", "recover_pose", "epipolar_lines",
    "distort_points", "undistort_points", "distort_image", "undistort_image", "estimate_distortion", "stereo_rectify", "camera_calibration",
    "odometry", "rgbd_odometry", "pnp_odometry", "integrate_trajectory",
    "umeyama_align", "trajectory_error",
    "grasp", "Grasp", "sample_antipodal_grasps", "grasps_from_mesh", "force_closure",
    "ferrari_canny_quality", "approach_vector_from_normals", "rank_grasps",
